!(function () {
  ...
  (_tpt.dpr = Math.max(1, Math.min(2, window.devicePixelRatio || 1))),
    (_tpt.hop = (t, e) => Object.prototype.hasOwnProperty.call(t, e)),
    void 0 !== window.RVS &&
      void 0 !== window.tpGS &&
      (_tpt.gsap = window.tpGS.gsap),
    (_tpt.regResource = function (t) {
      (_tpt.R[t.id] ??= {}),
        (_tpt.R[t.id].status ??= 0),
        void 0 !== t.url && (_tpt.R[t.id].url = t.url),
        void 0 !== t.fonts && (_tpt.R[t.id].fonts = t.fonts),
        void 0 !== t.css && (_tpt.R[t.id].css = t.css),
        void 0 !== t.fontfamily && (_tpt.R[t.id].fontfamily = t.fontfamily),
        void 0 !== t.fonticon && (_tpt.R[t.id].fonticon = t.fonticon);
    }),
      ...
      return (
        t.forEach((t) => {
          ...
          void 0 !== e &&
            2 !== e.status &&
            ("DOM" === t
              ? ((_tpt.R[t].status = 1), r.push(_tpt.waitForDOM(t)))
              : void 0 !== e.fonticon
              ? (r.push(_tpt.loadCSS(e.url, t)),
                e.woff2 && r.push(_tpt.loadWoff2(e.woff2, t)))
              : void 0 !== e.url
              ? r.push(_tpt.loadScript(e.url, t, e.test, e.listen))
              : e.fonts || (e.css && r.push(_tpt.loadCSS(e.css, t))));
        }),
    ...
    (_tpt.loadScript = function (t, e) {
      return new Promise(async (r, n) => {
        ...
        for (const i of t)
          if (_tpt.loadingScripts[i])
            try {
              if ((await _tpt.loadingScripts[i], 2 === _tpt.R[e].status))
                return void r();
            } catch (t) {
              console.error(t);
            }
    ...
    (_tpt.loadWoff2 = async function (t, e) {
      return (
        ...
        new Promise((r, n) => {
          ...
          (i.type = "text/css"),
            i.classList.add("sr7-inline-css"),
    ...
    (_tpt.urlProtocol = function (t, e) {
      return "/" == ("" + t)[0] && "/" == ("" + t)[1]
        ? (e ? "https:" : window.location.protocol) + t
        : ("" + t).includes("://")
        ? (e || t.includes("https") ? "https:" : window.location.protocol) +
          "//" +
    ...
    (_tpt.restAPILoad = async function (t) {
      ...
      return (
        (e +=
          "get_full_slider_object" == t.action
            ? "sliderrevolution/sliders/"
            : "get_stream_data" == t.action
            ? "sliderrevolution/sliders/stream/"
            : "get_modal_settings" == t.action
            ? "sliderrevolution/sliders/modal/"
            : ""),
        (e +=
          (null == t.id ? t.alias ?? "" : _tpt.restApiIdCut(t.id)) +
          (e.includes("?")
            ? "&srengine=" + (6 == t.version ? 6 : 7)
            : "?srengine=" + (6 == t.version ? 6 : 7))),
        null == t.id &&
          t.forcealias &&
          void 0 !== t.alias &&
          (e += e.includes("?") ? "&alias=true" : "?alias=true"),
        "get_stream_data" == t.action &&
          SR7.E?.wpml?.lang &&
          (e += (e.includes("?") ? "&srlang=" : "?srlang=") + SR7.E.wpml.lang),
        "get_full_slider_object" == t.action &&
          void 0 !== t.slideid &&
          (e += (e.includes("?") ? "&slideid" : "?slideid") + "=" + t.slideid),
        t.raw && (e += (e.includes("?") ? "&raw" : "?raw") + "=true"),
        new Promise((t, n) => {
    ...
    (_tpt.measureAverageFrameRate = (e, r, n = 30) =>
      new Promise((i) => {
        let s = [],
          o = [],
          a = 0;
          ...
          l = () => {
            if (SR7?.M[r]?.states?.inViewPort) {
              ...
              performance.now() - u < e
                ...
                : i({ averageFPS: t(s, u), lowFrameRateCount: a });
            } else i({ averageFPS: t(s, u), lowFrameRateCount: a });
          };
        requestAnimationFrame(l);
      })),
    (_tpt.fixResponse = (t) => {
      ...
      for (let i = 0; i < t.length; i++) {
        ...
        if (
          ...
          let e = t.substring(r, i + 1);
          r = -1;
          try {
            let t = JSON.parse(e);
            n.push(t);
          } catch (t) {
            console.error("Invalid JSON object encountered:", t);
          }
        }
      }
      for (let t of n) if (t && !0 === t.success) return t;
      return null;
    }),
    ...
    (_tpt.ajaxLoad = async function (t, e = 5) {
      var r = t.url || window.SR7.E.ajaxurl,
        ...
        i = {
          action:
            ("get_full_slider_object" == t.action && !0 !== t.backend) ||
            "get_stream_data" == t.action ||
            "get_modal_data" == t.action
      ...
      return (
        "get_full_slider_object_v7" == t.action &&
          (r += r.includes("?") ? "&srengine=6" : "?srengine=6"),
        new Promise((s, o) => {
    ...
    (_tpt.getSVG = async function (t, e, r) {
      t = (t = (t = _tpt.urlProtocol(t)).replace(
        "/public/assets/assets/svg/",
        "/public/assets/svg/"
      )).replace("/public/assets/assets/sources/", "/public/assets/sources/");
      try {
        const n = await _tpt.loadSVG(t);
    ...
    (_tpt.loadSVG = async function (t) {
      return (
        ...
        _tpt.svgCache[t]
          ? Promise.resolve(_tpt.svgCache[t])
          : new Promise((e, r) => {
              var n = new XMLHttpRequest();
              n.overrideMimeType("image/svg+xml"),
                n.open("GET", t, !0),
                (n.onload = () => {
    ...
    (_tpt.createNS = (t) => {
      var e;
      for (e in ((t.n = document.createElementNS(
        "http://www.w3.org/2000/svg",
        t.n
      )),
      t.v))
        t.n.setAttributeNS(
          null,
          e.replace(/[A-Z]/g, function (t, e, r, n) {
            return "-" + t.toLowerCase();
          }),
          t.v[e]
        );
      for (e in (void 0 !== t.c && t.n.setAttribute("class", t.c),
      void 0 !== t.id && (t.n.id = t.id),
      void 0 !== t.t && (t.n.textContent = t.t),
      t.s))
        t.s.hasOwnProperty(e) && (t.n.style[e] = t.s[e]);
      return t.n;
    }),
    ...
    (_tpt.lineBreaks = (t, e) =>
      "#srfshcd#" == t.slice(0, 9)
        ...
        ? t.split("\n").join("<br>").replace(/\n/g, "<br/>")
        : t.replace("\n", "")),
    (_tpt.trim = (t) => (null != t && "string" == typeof t ? t.trim() : t)),
    (_tpt.iOSVersion =
      !!(
    ...
    (_tpt.isIOS =
      ...
      ("MacIntel" === navigator.platform && void 0 !== navigator.standalone)),
    ...
    (_tpt.is_mobile = (function () {
      ...
      if (void 0 !== window.orientation) e = !0;
        ...
        for (var r in t)
          _tpt.hop(t, r) &&
            (e = !!(e || navigator.userAgent.split(t[r]).length > 1) || e);
      return (
        e &&
          document.body &&
    ...
    (_tpt.browser =
      ...
      /trident/i.test(n[1])
        ? ((e = /\brv[ :]+(\d+)/g.exec(r) || []), "IE")
        : "Chrome" === n[1] && null != (e = r.match(/\b(OPR|Edge)\/(\d+)/))
        ? e[1].replace("OPR", "Opera")
        : ((n = n[2]
            ? [n[1], n[2]]
            : [navigator.appName, navigator.appVersion, "-?"]),
          null != (e = r.match(/version\/(\d+)/i)) && n.splice(1, 1, e[1]),
          n[0]))),
    ...
    (_tpt.browserVersion = (function () {
      ...
      return (
        n && null != (t = r.match(/version\/([\.\d]+)/i)) && (n[2] = t[1]),
        (n = n ? [n[1], n[2]] : [e, navigator.appVersion, "-?"])[1]
      );
    })()),
    (_tpt.isSafari11 =
      "safari" === _tpt.trim(_tpt.browser.toLowerCase()) &&
    ...
    (_tpt.is_mozilla = navigator.userAgent.includes("Firefox")),
    (_tpt.normalizeWheel = (t) => {
      let e = 0;
      return (
        "deltaY" in t || "deltaX" in t
          ? (e =
              (0 != t.deltaY && -0 != t.deltaY) ||
              !(t.deltaX < 0 || t.deltaX > 0)
                ? t.deltaY
                : t.deltaX)
          : ("detail" in t && (e = t.detail),
            "wheelDelta" in t && (e = -t.wheelDelta / 120),
            "wheelDeltaY" in t && (e = -t.wheelDeltaY / 120)),
        (e = _tpt.is_mozilla ? 10 * e : e),
        (e > 300 || e < -300) && (e /= 10),
        e
      );
    }),
    ...
    (_tpt.removeEmptyTags = (t) => {
      t.forEach((t) => {
        ("" !== t.innerHTML.trim() &&
          ("" !== t.textContent || 0 != t.children?.length)) ||
          ("" + t.className).includes("sr") ||
          ("" + t.className).includes("rev") ||
          t.remove();
      });
    }),
    (_tpt.gA = function (t, e, r) {
      return void 0 === t
        ...
        : t.hasAttribute &&
          ...
          void 0 !== t.getAttribute("data-" + e) &&
          null !== t.getAttribute("data-" + e)
  ...
  function s(t, e, r) {
    ...
    if (((n.width = 100), (n.height = 200), 0 === t.length)) i.fillStyle = r;
      ...
      for (
        var s = i.createLinearGradient(0, 0, 100, 0), o = 0;
        o < t.length;
        o++
      )
        s.addColorStop(t[o].stop / 100, t[o].color);
      i.fillStyle = s;
    }
  ...
  function o(t, e, r, n) {
    for (
      var i = "",
        s = _tpt.gsap.utils.mapRange(0, n.length - 1, 0, t.length - 1),
        o = 0;
      o < n.length;
      o++
    ) {
  ...
  function a(t) {
    ...
    for (var s = 0; s < r.length; s++) {
      ...
      t[0] && (t = t[0]),
        a[1] && (a = a[1]),
        i.push(parseFloat(a)),
        n.push({ color: t, stop: parseFloat(a) });
    }
    return (
      0 === n.length &&
        (n.push({ color: t, stop: 0 }),
        i.push(0),
        n.push({ color: t, stop: 100 }),
        i.push(100)),
      { points: n, stops: i }
    );
  }
  (_tpt.tEvtSimple = (t) =>
    _tpt.is_mobile
      ...
      : t),
    (_tpt.tEvt = (t) =>
      Array.isArray(t) ? t.map((t) => _tpt.tEvtSimple(t)) : _tpt.tEvtSimple(t)),
    (_tpt.event = {
      listeners: {},
      timestamps: {},
      ...
      listen: (t, e, r, n, i) => {
        _tpt.is_mobile && "mouseleave" === e && (e += " touchend");
        const s = e.split(" "),
          o = [];
        return (
          s.forEach((e) => {
            const s = _tpt.event.getId(),
              a = (t) => {
                (void 0 !== _tpt.event.timestamps[t.target.id] &&
                  _tpt.event.timestamps[t.target.id] > t.timeStamp) ||
                  ((_tpt.event.timestamps[t.target.id] = t.timeStamp), r(t, n));
              };
            _tpt.event.listeners[t.id] || (_tpt.event.listeners[t.id] = []),
              _tpt.event.listeners[t.id].push({
                id: s,
                eventType: e,
                eventListener: a,
              }),
              t.addEventListener(e, a, i ? { passive: !1 } : { passive: !0 }),
              o.push(s);
          }),
          o
        );
      ...
      hasListener: (t) =>
        void 0 !== _tpt.event.listeners[t.id] &&
        _tpt.event.listeners[t.id].length > 0,
      rm: (t, e) => {
        if (!_tpt.event.listeners[t.id]) return;
        const r = _tpt.event.listeners[t.id].findIndex((t) => t.id == e);
        if (-1 === r) return;
        const { eventType: n, eventListener: i } =
          _tpt.event.listeners[t.id][r];
        return (
          t.removeEventListener(n, i),
          _tpt.event.listeners[t.id].splice(r, 1),
          "removed"
        );
      },
      rmAll: (t) => {
        _tpt.event.listeners[t.id] &&
          (_tpt.event.listeners[t.id].forEach((e) => {
    ...
    (_tpt.keyBoard = {
      reg: (t, e, r, n) => {
        (_tpt.event.keyboardTargets ??= {}),
          _tpt.event.keyboardTargets[e] ||
            ((_tpt.event.keyboardTargets[e] = { id: t, callback: r, keys: n }),
            _tpt.keyBoard.isListening ||
              ...
              _tpt.event.listen(
                ...
                function (t, e) {
                  if ("INPUT" === document.activeElement.tagName)
                    ...
                    for (let r in _tpt.event.keyboardTargets)
                      _tpt.hop(_tpt.event.keyboardTargets, r) &&
                        _tpt.event.keyboardTargets[r].keys.includes(t.key) &&
                        _tpt.event.keyboardTargets[r].callback(t, e);
                },
                { id: t, cid: e, keys: n }
              )));
      },
    ...
    (_tpt.padMarArr = function (t) {
      ...
      for (
        r || (t = [t]),
          t.length < 5 && t.unshift(["auto", "auto", "auto", "auto"]),
          e = 0;
        e < 5;
        e++
      )
        (t[e] =
          void 0 === t[e]
            ...
            : [t[e]]),
          2 == t[e].length
            ? (t[e] = [t[e][0], t[e][1], t[e][0], t[e][1]])
            : 3 == t[e].length
            ? (t[e] = [t[e][0], t[e][1], t[e][2], t[e][1]])
            : t[e].length < 4 && (t[e] = _tpt.fillArray(t[e], 4));
      return [...t];
    }),
    (_tpt.explodeData = function (t) {
      ...
      var e,
        ...
        n = {};
      for (r in t)
        void 0 !== (e = t[r].split(":"))[0] && "" !== e[0] && (n[e[0]] = e[1]);
      return n;
    }),
    (_tpt.isNumeric = (t) => !isNaN(parseFloat(t)) && isFinite(t)),
    (_tpt.getHighestAttribute = function (t, e, r = 0) {
    ...
    (_tpt.unitize = (t, e = "px") =>
      parseFloat(t) == t ? (-1 == e ? t : t + e) : -1 == e ? parseInt(t) : t),
    (_tpt.divSize = (t) => {
      if ("#" == ("" + t)[0]) {
    ...
    (_tpt.mText = (t = "", e = "") =>
      t.trim() + ("" !== t && "" !== e ? " " : "") + e.trim()),
    (_tpt.defNum = (t, e) =>
      null == t || isNaN(parseFloat(t)) ? e : parseFloat(t)),
    (_tpt.gradient = {
      SSGCache: [],
      getSSGColors: (t, e, r) => {
        if (
          ...
          return { from: t, to: e };
        for (
          var n = { from: t, to: e }, i = 0;
          i < _tpt.gradient.SSGCache.length;
          i++
        ) {
          if (
            _tpt.gradient.SSGCache[i].from === t &&
            _tpt.gradient.SSGCache[i].to === e &&
            _tpt.gradient.SSGCache[i].type === r
          )
            return {
          ...
          if (
            _tpt.gradient.SSGCache[i].from === e &&
            _tpt.gradient.SSGCache[i].to === t &&
            _tpt.gradient.SSGCache[i].type === r
          )
            return {
        ...
        var p,
          c,
          h = u.stops;
        for (i = 0; i < l.stops.length; i++)
          -1 === h.indexOf(l.stops[i]) && h.push(l.stops[i]);
        if (
          (h.sort(function (t, e) {
            return t - e;
          }),
          ...
          (p = t.substring(0, f)),
            -1 === e.indexOf("gradient(") && (c = t.substring(0, f));
        }
        if (-1 !== e.indexOf("gradient(")) {
          ...
          (c = e.substring(0, f)),
            -1 === t.indexOf("gradient(") && (p = e.substring(0, f));
        }
        return (
          "fading" === r
            ? (u.stops.length,
            ...
            : "sliding" === r &&
              (u.stops.length > l.stops.length
                ? (c += o(l.points, 0, 0, u.points))
                : (p += o(u.points, 0, 0, l.points))),
          (p += ")"),
          (c += ")"),
          "sliding" === r &&
            (u.stops.length > l.stops.length ? (p = t) : (c = e)),
          (n.rFrom = p),
          (n.rTo = c),
          (n.tyep = r),
          _tpt.gradient.SSGCache.push(n),
          { from: p, to: c }
        );
      },
      getSVGReference: (t) => {
        ...
        else if (_tpt.gradient.svgReferences[e.string])
          return _tpt.gradient.svgReferences[e.string];
        ...
        return (
          _tpt.gradient.SVG.appendChild(n),
          (_tpt.gradient.svgReferences[e.string] =
            "url(#tp_svg_gradient_" + _tpt.gradient.svgRefIndex + ")"),
          (_tpt.gradient.svgNode[_tpt.gradient.svgRefIndex] = n),
      ...
      getColorStops: (t, e) => {
        ...
        for (; null !== (a = r.exec(t)); ) {
          ...
          const r = t
            ? _tpt.gradient.hexToRgba(t)
            : `rgba(${a[2]},${a[3]},${a[4]},${a[6] || "1"})`;
          (r === l && e === o) || (u.push({ rgba: r, p: e }), (o = e), (l = r)),
            u.some((t) => null === t.p) &&
              u.forEach((t, e) => {
                null === t.p && (t.p = (100 / (u.length - 1)) * e || 0);
              });
        }
        return { colors: u, type: i, angle: s };
      },
      hexToRgba: (t) =>
        `rgba(${parseInt(t.substring(1, 3), 16)},${parseInt(
          t.substring(3, 5),
          16
        )},${parseInt(t.substring(5, 7), 16)},1)`,
      convert: (t) => {
        let e = {};
        if (null == t) return t;
        if ("string" == typeof t) {
          ...
          if (t.includes("&") || (t.includes("{") && t.includes('"')))
            if (
              ((e = JSON.parse(t.replaceAll("&", '"'))),
              (e.orig ??= { ...e.colors }),
              delete e.colors,
              "string" == typeof e.orig)
            ) {
              ...
              Array.isArray(e.orig) ||
                "object" != typeof e.orig ||
                (e.orig = Object.values(e.orig));
              for (let t in e.orig)
                e.orig[t] = {
                  rgba:
                    e.orig[t]?.rgba ??
                    e.orig[t]?.rgbaColor ??
                    `rgba(${e.orig[t]?.r ?? 0}, ${e.orig[t]?.g ?? 0}, ${
                      e.orig[t]?.b ?? 0
                    }, ${e.orig[t]?.a ?? 0})`,
            ...
            if (!t.includes("gradient"))
              return (
                  ...
                  (t = JSON.parse(t).orig),
                {
                  type: "solid",
                  orig: t,
                  string: _tpt.gradient.getString({ type: "solid", orig: t }),
                }
              );
            {
              let {
              ...
              e = { orig: n, type: i, angle: r, strength: 100, easing: "none" };
            }
          }
        } else
          "object" == typeof t &&
            ((e = { ...t }), (e.orig ??= { ...e.colors }), delete e.colors);
        return (
          (e.angle = 180 === e.angle || void 0 === e.angle ? 180.1 : e.angle),
          (e.strength = e.strength || 100),
          (e.easing = e.easing || "none"),
          (e.string = _tpt.gradient.getString(e)),
          Array.isArray(e.orig) ||
            "object" != typeof e.orig ||
            ((e.orig = Object.values(e.orig)), (e.orig = u(e.orig))),
          e
        );
      },
      getString: (t, e = !1) => {
        if ("string" == typeof t.orig) {
          ...
          const e = window[
            null == window._tpt?.gsap ? "tpGS" : "_tpt"
          ].gsap.utils.splitColor(t.orig) || [0, 0, 0, 1];
        ...
        return (
          "linear" === t.type
            ? (a += "linear-gradient(" + (n ? "" : t.angle + "deg"))
            : "radial" === t.type && (a += "radial-gradient(circle"),
          (a += r
            .map(
              (t, r) => (
                (t.rgba = _tpt.gradient.toRGBA(t.rgba)),
                e && void 0 !== o && t.rgba == o.rgba && o.p == t.p
                  ? ""
                  : ((o = { p: t.p, rgba: t.rgba }),
                    (s = `${0 === r && n ? "" : ","}${t.rgba} ${t.p}%`),
                    s !== i ? (i = s) : (s = ""),
      ...
      process: (t, e) => (
        "object" != typeof t ||
          (void 0 !== t.easing &&
            "none" !== t.easing &&
            ((t.colors = _tpt.gradient.ease(t)),
            (t.string = _tpt.gradient.getString(t)),
            (e = !1)),
          (t.colors ??= t.orig),
          Array.isArray(t.colors) ||
            "object" != typeof t.colors ||
            (t.colors = Object.values(t.colors)),
          (t.string =
            e || null == t.string ? _tpt.gradient.getString(t) : t.string)),
        t
      ),
      ease: (t) => {
        let { strength: e, orig: r, easing: n } = t;
        if (
          ((e = 0.01 * parseInt(e, 10) * 15),
          (n = t.easing.split(".")),
          n.length < 2)
        )
          return { ...t.orig };
        if (
          (r.sort(_tpt.sortPoints),
          (n = _tpt.gradient.easing[n[0]][n[1]]),
          null == n)
        )
          return { ...t.orig };
        let i = r.length - 1,
        ...
        for (let t = 0; t < i; t++)
          (s[s.length] = r[t]),
            _tpt.gradient.insertPoints(r[t], r[t + 1], s, n, e);
      ...
      calcPoints: (t, e, r) => {
        const n = ((r * Math.PI) / 180) * -1,
          ...
          s = t / 2,
          o = {
            k: { x: s - Math.tan(n) * i, y: 0 },
            j: { x: s + Math.tan(n) * (e - i), y: e },
            ky: { x: t, y: i + (t - s) / Math.tan(n) },
            jy: { x: 0, y: i - s / Math.tan(n) },
          };
        let a = {},
          u = {};
        return (
          ...
          r > 90 && r < 315
            ? { tx: a.x, ty: a.y, bx: u.x, by: u.y }
            : { tx: u.x, ty: u.y, bx: a.x, by: a.y }
        );
      },
      getLinear: (t, e, r, n) => {
        ...
        for (
          ...
          g.push(c(d[_], f));
        if (
          (SR7.F.dist(u, p, g[0].x, g[0].y) > SR7.F.dist(u, p, g[1].x, g[1].y)
            ? ((i = g[0].x), (s = g[0].y))
            : ((i = g[1].x), (s = g[1].y)),
          SR7.F.dist(u, p, g[2].x, g[2].y) > SR7.F.dist(u, p, g[3].x, g[3].y)
            ? ((o = g[2].x), (a = g[2].y))
            : ((o = g[3].x), (a = g[3].y)),
          Math.round(100 * Math.atan2(p - s, u - i)) / 100 ===
            Math.round((n % (2 * Math.PI)) * 100) / 100)
        ) {
          var m = i,
            D = s;
          (i = o), (s = a), (o = m), (a = D);
      ...
      insertPoints: (t, e, r, n, i) => {
        ...
        var a = t.p,
          u = e.p;
        if (!(a > u)) {
          for (var l, p, c, h = [], f = 0; f < i; f++)
            (p = parseFloat(n(f, 0, 1, i).toFixed(2)) * (u - a) + a) > a &&
              p < u &&
              (h[h.length] = p);
          var d,
            g,
          ...
          for (f = 0; f < _; f++)
            (c = h[f]) !== t.p &&
              ((d = _tpt.sanitizeAlpha(s.a)),
              (g = _tpt.sanitizeAlpha(o.a)),
              (l = {
                p: D,
                rgba: _tpt.gradient.toRGBA({
                  r:
                    s.r !== o.r
                      ? Math.round(_tpt.distColor(c, a, u, s.r, o.r))
                      : s.r,
                  g:
                    s.g !== o.g
                      ? Math.round(_tpt.distColor(c, a, u, s.g, o.g))
                      : s.g,
                  b:
                    s.b !== o.b
                      ? Math.round(_tpt.distColor(c, a, u, s.b, o.b))
                      : s.b,
                  a:
                    d !== g
                      ? _tpt.sanitizeAlpha(_tpt.distAlpha(c, a, u, s.a, o.a))
                      : d,
                }),
              }),
              (D += m),
      ...
      toRGBA: (t) => {
        if ("object" == typeof t)
          return void 0 !== t.rgba && "string" == typeof t.rgba
            ? t.rgba
            : "rgba(" + t.r + "," + t.g + "," + t.b + "," + (t.a ?? 1) + ")";
        var e =
          window[null == _tpt.gsap ? "tpGS" : "_tpt"].gsap.utils.splitColor(t);
        return (
          "rgba(" + e[0] + "," + e[1] + "," + e[2] + "," + (e[3] ?? 1) + ")"
        );
      },
      easing: {
        quint: {
        ...
        bounce: {
          ...
          easeinout: function (t, e, r, n) {
            return t < n / 2
              ? 0.5 * RSColor.easing.bounce.easein(2 * t, 0, r, n) + e
              : 0.5 * RSColor.easing.bounce.easeout(2 * t - n, 0, r, n) +
                  0.5 * r +
                  e;
          },
        },
    ...
    window.tpGS &&
      null == window.tpGS?.getSSGColors &&
      (window.tpGS.getSSGColors = _tpt.gradient.getSSGColors);
  const u = (t) =>
      t.filter(
        (e, r) =>
          r === t.length - 1 || e.rgba !== t[r + 1].rgba || e.p !== t[r + 1].p
      ),
    l = (t, e) => {
      var r = e + Math.PI / 2;
      return {
    ...
    p = (t) => {
      ...
      return { r: e[0], g: e[1], b: e[2], a: e[3] ?? 1 };
    };
  function c(t, e) {
    var r = t.y2 - t.y1,
      n = t.x1 - t.x2,
  ...
  (_tpt.distAlpha = (t, e, r, n, i) =>
    Math.max(
      Math.min(
        Math.abs(
          parseFloat((((t - e) / (r - e)) * (i - n)).toFixed(2)) + parseFloat(n)
        ),
        1
      ),
      0
    )),
    (_tpt.distColor = (t, e, r, n, i) =>
      Math.max(
        Math.min(Math.round(Math.abs(((t - e) / (r - e)) * (i - n) + n)), 255),
        0
      )),
    (_tpt.sanitizeAlpha = (t) =>
      parseFloat(
        Math.max(Math.min(parseFloat(t), 1), 0)
          .toFixed(2)
          .replace(/\.?0*$/, "")
      )),
    (_tpt.inBounds = (t, e, r) => t >= e && t <= r),
    (_tpt.parseColor = (t, e) => (
      (t = _tpt.gsap.utils.splitColor(t)).length <= 3 && (t[3] = 1),
      e ? t : t.map((t, e) => (e < 3 ? t / 255 : t))
    )),
    (_tpt.getHexColor = (t) =>
      `#${t
        .slice(0, 3)
        ...
        .join("")}`),
    (_tpt.checkFontLoaded = function (t, e = "normal", r = "normal", n) {
      return (
        (t = t.replace(/^"(.*)"$/, "$1")),
        new Promise((i, s) => {
          _tpt.ongoingTests ??= {};
          let o = `${t}-${e}-${r}`;
          _tpt.ongoingTests[o] ||
            (_tpt.ongoingTests[o] = new Promise((i, s) => {
              if (1 == (_tpt.R?.fonts?.[t] ?? 0)) return void i();
              let o,
                a = t.includes("Material Icons") || t.includes("FontAwesome"),
                u =
                  "Material Icons" == t
                    ? "wb_incandescent"
                    : "FontAwesome" == t || "Pe-icon-7-stroke" == t
                    ? ""
                    : "BESbswy",
              ...
              (l.style.fontFamily = "sans-serif"),
                (l.style.fontWeight = e),
                (l.style.fontStyle = r),
                (l.textContent = u),
                _tpt.fontTester ||
                  ((_tpt.fontTester =
                    document.createElement("sr7-fonttest-wrap")),
                  document.body.appendChild(_tpt.fontTester)),
                _tpt.fontTester.appendChild(l);
              let h = l.offsetWidth,
                f = l.offsetHeight;
              if (
                ((l.style.fontFamily = `'${t}', sans-serif`),
                "FontAwesome" == t
                  ? l.classList.add("fa-power-off")
                  : "Pe-icon-7-stroke" == t && l.classList.add("pe-7s-album"),
                h !== l.offsetWidth || f !== l.offsetHeight)
              )
                return (
                  (_tpt.R.fonts ??= {}), (_tpt.R.fonts[t] = 1), c(), void i()
                );
              (o = setInterval(() => {
                (l.offsetWidth === h && l.offsetHeight === f) ||
                  ((_tpt.R.fonts ??= {}), (_tpt.R.fonts[t] = 1), c(), i());
              }, 19)),
                setTimeout(() => {
                  c(), i();
                }, n);
    ...
    (_tpt.registerFont = function (t = {}) {
      ...
      if (
        ((_tpt.R.fonts.required[e] ??= {
          name: e,
          orig: t.family,
          italic: {},
          normal: {},
        }),
        t.link && (_tpt.R.fonts.required[e].link = t.link),
        t.url &&
          (_tpt.R.fonts.required[e].url ??= { url: t.url }) &&
          (_tpt.R.fonts.required[e].url.state ??= 0),
        void 0 !== t.weight)
      ) {
        t.weight = Array.isArray(t.weight) ? t.weight : [t.weight];
        for (var r = 0; r < t.weight.length; r++)
          "auto" !== t.weight[r] &&
            (_tpt.R.fonts.required[e][t.italic ? "italic" : "normal"][
              t.weight[r]
            ] ??= 0);
      }
    }),
    ...
    (_tpt.updateFontStatus = function (t) {
      for (let e in _tpt.R.fonts.required)
        if (_tpt.hop(_tpt.R.fonts.required, e))
          for (let r of ["normal", "italic"])
            for (let n in _tpt.R.fonts.required[e][r])
              _tpt.hop(_tpt.R.fonts.required[e][r], n) &&
                _tpt.R.fonts.required[e][r][n] === t &&
                (_tpt.R.fonts.required[e][r][n] = 2);
    }),
    (_tpt.getLoadedFontFaces = function () {
      var t = {};
      for (let e of document.fonts) {
        let r = e.family.replace(/['"]+/g, "");
        t[r] = t[r] || { italic: [], normal: [] };
        let n = e.weight,
    ...
    (_tpt.getExistingGoogleFonts = function () {
      for (
        var t = {}, e = document.getElementsByTagName("link"), r = 0;
        r < e.length;
        r++
      ) {
        ...
        if (
          ...
          for (let r in e) {
            ...
            if (null == e[r] || null == e[r] || null == n[1] || null == n[1])
              continue;
            let i = n[1].split(":"),
              s = n[1].split("@");
            if (null == i || null == i || null == i[0] || null == i[0])
              continue;
            if (null == s || null == s || null == s[1] || null == s[1])
              continue;
            (i = i[0]), (t[i] ??= { italic: [], normal: [] });
            let o = s[1].split(";");
            for (let e = 0; e < o.length; e++) {
              let r = o[e].split(","),
                n = 1 == r[0] || "1" == r[0] || 1 == r[1] || "1" == r[1];
              for (let e = 0; e < r.length; e++)
                r[e] > 1 && t[i][n ? "italic" : "normal"].push(parseInt(r[e]));
            }
          }
        }
      }
    ...
    (_tpt.loadFonts = async function (t) {
      if (!window.SR7?.E?.ignoreGoogleFont && null != _tpt.R.fonts) {
        ...
        _tpt.R.fonts.required)) {
          ...
          if (
            t.includes("arial") ||
            t.includes("palatino+linotype") ||
            t.includes("times+new+roman") ||
            t.includes("georgia") ||
            t.includes("tahoma")
          )
            continue;
          let l = i.replaceAll("'", ""),
            p =
              _tpt.R?.fonts?.customFonts?.[i] ??
              _tpt.R?.fonts?.customFonts?.[l] ??
              !1;
          if (void 0 !== e.url || p)
            (e.url ??= {}),
              0 == e.url.state &&
                (p && ("string" == typeof p ? (e.url.url = p) : (e.url = p)),
                u.push({ font: i, url: e.url })),
              (e.url.state = 1);
          else {
            for (s of ((r = ""), ["normal", "italic"]))
              for (n in e[s])
                if (_tpt.hop(e[s], n) && 0 == e[s][n]) {
                  (e[s][n] = a),
                    (n = parseInt(n)),
                    (e.name = _tpt.fixGoogleFontNames(e.name));
                  ...
                  if (
                    _tpt.isWeightInRange(
                      n,
                      _tpt.R?.fonts?.domFonts?.[e.orig]?.[s] ?? []
                    )
                  )
                    continue;
                  if (
                    _tpt.isWeightInRange(
                      n,
                      _tpt.R?.fonts?.domFonts?.[e.name]?.[s] ?? []
                    )
                  )
                    continue;
                  "" !== r
        ...
        if ("" !== o && " " !== o) {
          o = (o =
            ...
            "?" +
            o +
            "&display=swap").replace("?family=?family=", "?family=");
          var l = document.createElement("link");
          (l.rel = "stylesheet"),
            (l.href = o.replace("undefined", "/")),
            (l.onload = (function (t, e) {
              for (i in _tpt.R.fonts.required)
                if (_tpt.hop(_tpt.R.fonts.required, i))
                  for (s of ["normal", "italic"])
                    for (n in _tpt.R.fonts.required[i][s])
                      _tpt.hop(_tpt.R.fonts.required[i][s], n) &&
                        _tpt.R.fonts.required[i][s][n] === t &&
                        (_tpt.R.fonts.required[i][s][n] = 2);
              "function" == typeof e && e();
            })(a, t)),
            (l.onerror = function () {
              _tpt.skipFontTrys = !0;
        ...
        if (u.length > 0)
          for (let t in u)
            (u[t].url?.url ?? "").endsWith(".css")
              ? _tpt.loadCSS(u[t].url.url, u[t].font, !0)
              : ((_tpt.R[u[t].font] ??= {}),
                _tpt.loadFontFace(u[t].url.url, u[t].font));
      }
    }),
    (_tpt.compareURL = function (t, e) {
      return (
        !(!t || !e) &&
        (t == e ||
          ((t = _tpt.urlProtocol(t)),
          (e = _tpt.urlProtocol(e)),
          (t = _tpt.normalizeUrl(t)) == (e = _tpt.normalizeUrl(e))))
      );
    }),
      ...
      if (t) {
        ...
        if (
          ...
          (_tpt.R.images.all[a] = {
            ...
            (_tpt.R.images.indexMap[e] = a);
        }
        "loaded" === _tpt.R.images.all[a].state ||
        "cached" === _tpt.R.images.all[a].state
          ? "function" == typeof r && r(_tpt.R.images.all[a])
          : ((_tpt.R.images.all[a].prio = e),
            (_tpt.R.images.all[a].callBacks[n] = r)),
          _tpt.updateImageQueue();
      }
    }),
    (_tpt.updateImageQueue = function () {
      if (_tpt.R.images.busy) return void setTimeout(_tpt.updateImageQueue, 5);
      (_tpt.R.images.busy = !0),
        _tpt.R.images.all.sort((t, e) => t.prio - e.prio),
        _tpt.R.images.all.forEach((t, e) => {
          t && (_tpt.R.images.indexMap[t.id] = e);
        });
      let t = 0;
      for (let e = 0; e < 5; e++)
        if (void 0 === _tpt.R.images.queue[e])
          for (let r = t; r < _tpt.R.images.alllen; r++)
            if ("pending" === _tpt.R.images.all[r].state) {
              (_tpt.R.images.queue[e] = _tpt.R.images.all[r].id),
                (_tpt.R.images.all[r].state = "inqueue"),
                (t = r);
              break;
            }
      _tpt.processImageQueue(), (_tpt.R.images.busy = !1);
    }),
    (_tpt.processImageCallbacks = function (t, e) {
      for (var r in _tpt.R.images.all[t].callBacks)
        _tpt.hop(_tpt.R.images.all[t].callBacks, r) &&
          "function" == typeof _tpt.R.images.all[t].callBacks[r] &&
          _tpt.R.images.all[t].callBacks[r](_tpt.R.images.all[t]);
      (_tpt.R.images.queue[e] = void 0), _tpt.updateImageQueue();
    }),
    (_tpt.processImageQueue = function () {
      for (let t = 0; t < 5; t++)
        if (void 0 !== _tpt.R.images.queue[t]) {
          let e = _tpt.R.images.indexMap[_tpt.R.images.queue[t]];
          "inqueue" === _tpt.R.images.all[e].state &&
            ((_tpt.R.images.all[e].state = "loading"),
            this.tryLoadImage(_tpt.R.images.all[e].id, t));
        }
    }),
    (_tpt.normalizeUrl = function (t) {
      return (
        "/" == (t = t.toLowerCase())[t.length - 1] && (t = t.slice(0, -1)),
        "http://" == t.slice(0, 7)
          ? (t = t.slice(7))
          : "https://" == t.slice(0, 8) && (t = t.slice(8)),
        t
      );
    }),
    (_tpt.normalizeNURL = (t) =>
      _tpt
        .normalizeUrl(t)
        .replaceAll("%20", " ")
        .replaceAll("%E2%80%AF", " ")
        ...
        .replaceAll(" ", "%20")
        .replaceAll(/\s/g, "%20")),
    (_tpt.findRequestedImage = function (t) {
      let e = _tpt.normalizeNURL(_tpt.normalizeUrl(t)),
        r = _tpt.findIndex(_tpt.R.images.all, "nurl", e);
      if (-1 !== r) return r;
      if (
        ((r = _tpt.findIndex(_tpt.R.images.all, "nurlshort", e.split("?")[0])),
        -1 !== r)
      )
        return r;
      if (
        ((r = _tpt.findIndex(
          _tpt.R.images.all,
          "nurl",
          e.replace(window.location.hostname, "")
        )),
        -1 !== r)
      )
        return r;
      if (
        ((r = _tpt.findIndex(_tpt.R.images.all, "nurl", decodeURIComponent(e))),
        -1 !== r)
      )
        return r;
      let n =
      ...
      return (
        (r = _tpt.findIndex(_tpt.R.images.all, "nurl", i)),
        -1 !== r
          ? r
          : ((r = _tpt.findIndex(
              _tpt.R.images.all,
              "nurl",
              _tpt.normalizeNURL(i)
            )),
            -1 !== r
              ? r
              : ((e = "./" + e), _tpt.findIndex(_tpt.R.images.all, "nurl", e)))
      );
    }),
    (_tpt.tryLoadImage = function (t, e, r = !1) {
      let n = _tpt.R.images.indexMap[t],
        i = _tpt.R.images.all[n],
        s = r ? !i.crossOrigin : i.crossOrigin;
      _tpt
        .loadSingleImage(i.url, e, s)
        .then((t) => {
          let r = _tpt.R.images.indexMap[i.id];
          (_tpt.R.images.all[r].state = t.status),
            (_tpt.R.images.all[r].image = t.image),
            (_tpt.R.images.all[r].width = t.image.width),
            (_tpt.R.images.all[r].height = t.image.height),
            _tpt.processImageCallbacks(r, e);
        })
        .catch((n) => {
          if (r) {
            const r = _tpt.R.images.indexMap[t];
            (_tpt.R.images.all[r].state = n.status),
              _tpt.processImageCallbacks(r, e),
              console.log(
                "Image Error: " +
                  _tpt.R.images.all[r].url +
                  " could not be loaded"
              );
    ...
    (_tpt.getMSize = function (t) {
      return (
        delete window.SR7.M[t].c,
        console.log(
          "Reference C has been deleted for Messuring. Reload Page after !!"
        ),
        _tpt.getObjectSize(window.SR7.M[t]) + "kb"
      );
    }),
    (_tpt.getObjectSize = function (t) {
      return (
        new TextEncoder().encode("string" == typeof t ? t : JSON.stringify(t))
          .length / 1024
      );
    }),
    (_tpt.loadSingleImage = async function (t, e, r = !0) {
      ...
      return new Promise((e, i) => {
        ...
        r && (s.crossOrigin = "anonymous"),
          (s.src = t),
          (s.onload = () => {
            e({ image: s, queueIndex: n, status: "loaded" });
          }),
          (s.onerror = () => {
            i({ url: t, queueIndex: n, status: "error" });
          }),
          s.complete && e({ image: s, queueIndex: n, status: "cached" });
      });
    }),
    (_tpt.isImageURL = (t) => {
    ...
    (_tpt.injectCssJs = (t = "", e = "", r, n) => {
      if ("" !== t) {
        let e,
          r = !1;
        void 0 !== n && ((e = document.getElementById(n)), (r = null != e)),
          r ||
            ((e = document.createElement("style")),
            e.classList.add("sr7-inline-css"),
            void 0 !== n && (e.id = n)),
          (e.innerHTML = (e.innerHTML ?? "") + t),
          r || document.getElementsByTagName("head")[0].appendChild(e);
      }
      if ("" !== e) {
    ...
    (_tpt.extndArray = (t, e) => (
      ...
      Array.isArray(t) || (t = [t]),
      Array.isArray(e) || (e = [e]),
      Array.from(new Set(t.concat(e)))
    )),
    (_tpt.extndArrWithObj = (t = [], e = {}, r = "src", n = "") => {
      let i;
      return (
        t.forEach((t) => {
          ...
          if (s.length === o.length) {
            if (s.every((r) => t[r] === e[r])) {
              ...
              !s && o
                ? ((t[r] = _tpt.extndArray(e[r], t[r])), (i = !0))
                : "" !== n &&
                  s &&
                  ((t[n] = _tpt.extndArray(e[n], t[n])), (i = !0));
            }
          }
        }),
        i || t.push(e),
    ...
    (_tpt.tf = (t) => "false" != t && 0 != t && ("true" == t || 1 == t || t)),
    (_tpt.findNested = (t, e, r) => {
      ...
      for (var r in e)
        if (e.hasOwnProperty(r)) {
          ...
          t.every(function (t) {
            ...
            (console.log("Mismatch property:", r),
    ...
    (_tpt.displayDeprecationWarnings = (t) => {
      if (t && t.warnings) {
        ...
        for (const [e, r] of Object.entries(t.warnings))
          r
            ? console.info(`"${e}" is deprecated. Use "${r}" instead.`)
            : console.info(`"${e}" is deprecated.`);
        console.groupEnd();
      }
    }),
    (_tpt.viewPortObserverManager = {
      ...
      inViewPortObserver: new IntersectionObserver(
        function (t) {
          t.forEach((t) => {
            t.target.observParams &&
              t.target.observParams.obj &&
              ((t.target.observParams.obj.states =
                t.target.observParams.obj.states || {}),
              (t.target.observParams.obj.states.inViewPort = t.isIntersecting));
          });
        },
        { rootMargin: "0px" }
      ),
        ...
        var e = new IntersectionObserver(
          function (t) {
            for (var e = 0; e < t.length; e++) {
              var r = t[e];
              r.isIntersecting
                ? (r.target.observParams.obj &&
                    ((r.target.observParams.obj.states ??= {}),
                    (r.target.observParams.obj.states.boundingClientRect =
                      r.boundingClientRect),
                    (r.target.observParams.obj.states.inViewPort =
                      r.isIntersecting),
                    _tpt.scrollObserver.run(r.target)),
                  void 0 !== r.target.observParams &&
                    (void 0 !== r.target.observParams.callBack &&
                      r.target.observParams.callBack(
                        r.target,
                        r.intersectionRatio
                      ),
                    void 0 !== r.target.observParams.toggleCall &&
                      r.target.observParams.toggleCall(
                        r.target.id,
                        r.intersectionRatio,
                        "scroll"
                      ),
                    r.target.observParams.runonce &&
                      delete r.target.observParams.callBack))
                : r.target.observParams &&
                  ((r.target.observParams.obj.states ??= {}),
                  (r.target.observParams.obj.states.inViewPort =
                    !!r.target.observParams?.obj?.settings?.fixed ||
                    r.isIntersecting),
                  r.target.observParams?.toggleCall?.(
                    r.target.id,
                    r.intersectionRatio,
    ...
    (_tpt.scrollObserver = {
        ...
        _tpt.scrollObserver.entries ||
          ...
          _tpt.is_mobile
            ...
            : document.addEventListener(
                "scroll",
                function (t) {
                  void 0 === _tpt.scrollObserver.RaF &&
          ...
          -1 == _tpt.scrollObserver.entries.indexOf(t) &&
            _tpt.scrollObserver.entries.push(t),
          _tpt.scrollObserver.run(t);
      },
      kill: (t) => {
      ...
      run: (t, e) => {
        if (
          (_tpt.scrollObserver.RaF &&
            (_tpt.scrollObserver.RaF = cancelAnimationFrame(
              _tpt.scrollObserver.RaF
            )),
          window.scrollY != _tpt.scrollObserver.y || e)
        )
          if (((_tpt.scrollObserver.y = window.scrollY), null == t)) {
            for (let t in _tpt.scrollObserver.entries)
              if (_tpt.hop(_tpt.scrollObserver.entries, t)) {
                if (
                  !1 !==
                  (_tpt.scrollObserver?.entries?.[t]?.observSR7Globals ?? !1)
                )
                  for (let e in _tpt.scrollObserver.entries[t].observSR7Globals)
                    _tpt.hop(
                      _tpt.scrollObserver.entries[t].observSR7Globals,
                      e
                    ) &&
                      _tpt.scrollObserver.entries[t].observSR7Globals[
                        e
                      ].callback(
                        _tpt.scrollObserver.entries[t].observSR7Globals[e]
                          .params
                      );
                0 !=
                  (_tpt.scrollObserver?.entries?.[t]?.observParams?.obj?.states
                    ?.inViewPort ?? !1) &&
                  _tpt.scrollObserver.process(_tpt.scrollObserver.entries[t]);
              }
          } else if (
            (!1 !== (t?.observParams?.obj?.states?.inViewPort ?? !1) &&
              _tpt.scrollObserver.process(t),
            t.observSR7Globals)
          )
            for (let e in t.observSR7Globals)
              _tpt.hop(t.observSR7Globals, e) &&
                t.observSR7Globals[e].callback(t.observSR7Globals[e].params);
      },
      process: (t) => {
        const e = t.observParams.obj;
        let r =
          "false" !== ("" + e.settings?.mod?.use ?? !1) ||
          "false" !== ("" + e.settings?.sbt?.use ?? !1);
        if (
          null != e.dims.module &&
          (e.c.moduleListeners?.scroll || r) &&
          ((e.dims.moduleRect = t.getBoundingClientRect()), e.settings)
        ) {
          if (r) {
            if ((delete e.scrollProcSA, e.settings.fixed))
              e.scrollProc =
                1 - Math.min(1, Math.max(0, window.scrollY / _tpt.winH));
            else {
              let t =
                e.dims.moduleRect.height >= _tpt.winH ||
                e.c.module.offsetTop > e.dims.moduleRect.height / 2;
              (e.scrollProcSA = t
                ? Math.max(
                    -1,
                    Math.min(
                      1,
                      1 -
                        ((e.dims.moduleRect.top - _tpt.winH) /
                          (_tpt.winH + e.dims.moduleRect.height)) *
                          -2
                    )
                  )
                : Math.max(
                    ...
                    Math.min(
                      1,
                      e.dims.moduleRect.top /
                        (e.dims.moduleRect.height || e.dims.module.h)
                    )
                  )),
                (e.settings?.rOFV ?? 1) && e.dims.moduleRect.height < _tpt.winH
                  ? (e.scrollProc =
                      e.dims.moduleRect.top >= 0 &&
                      e.dims.moduleRect.bottom <= _tpt.winH
                        ? 0
                        : e.dims.moduleRect.top < 0
                        ? e.dims.moduleRect.top / e.dims.moduleRect.height
                        : (e.dims.moduleRect.bottom - _tpt.winH) /
                          e.dims.moduleRect.height)
                  : ((t = !1),
                    (e.scrollProc = t
                      ? Math.max(
                          -1,
            ...
            (e.scrollProc = e.scrollProc || 0),
              (e.scrollProcSA ??= e.scrollProc);
          }
          void 0 !== t.observParams.scrollCallback &&
            t.observParams.scrollCallback(t.id);
        }
      },
    }),
    (_tpt.resizeObserver = {
      ...
      process: function () {
        1 != _tpt.resizeObserver.observed &&
      ...
      execute: function () {
        _tpt.getWinDim(!0);
        var t = new Date();
        for (var e in (t - _tpt.resizeObserver.timer >= 1e3 &&
          (_tpt.resizeObserver.timer = t),
        _tpt.resizeObserver.targets))
          _tpt.hop(_tpt.resizeObserver.targets, e) &&
            (clearTimeout(_tpt.resizeObserver.targets[e].timer),
            t - _tpt.resizeObserver.timer >=
            _tpt.resizeObserver.targets[e].delay
              ? _tpt.resizeObserver.targets[e].callBack(
                  _tpt.resizeObserver.targets[e].id
                )
              : (function (t) {
                  _tpt.resizeObserver.targets[t].timer = setTimeout(() => {
                    _tpt.resizeObserver.targets[t].callBack(
                      _tpt.resizeObserver.targets[t].id
                    );
    ...
    (_tpt.orientationObserver = {
      ...
      observe: function (t, e, r) {
        return (
          !(!_tpt.is_mobile || "function" != typeof t) &&
      ...
      process: function () {
        _tpt.orientationObserver.inited ||
      ...
      execute: function () {
        ...
        for (var e in (t - _tpt.resizeObserver.timer >= 1e3 &&
          (_tpt.resizeObserver.timer = t),
        _tpt.orientationObserver.targets))
          _tpt.hop(_tpt.orientationObserver.targets, e) &&
            (clearTimeout(_tpt.orientationObserver.targets[e].timer),
            t - _tpt.orientationObserver.timer >=
            _tpt.orientationObserver.targets[e].delay
              ? _tpt.orientationObserver.targets[e].callBack(
                  _tpt.orientationObserver.targets[e].id
                )
              : (function (t) {
                  _tpt.orientationObserver.targets[t].timer = setTimeout(() => {
                    _tpt.orientationObserver.targets[t].callBack(
                      _tpt.orientationObserver.targets[t].id
                    );
    ...
    (_tpt.focusObserver = {
      ...
      execute: function (t) {
        var e = new Date();
        for (var r in (e - _tpt.focusObserver.timer >= 1e3 &&
          (_tpt.focusObserver.timer = e),
        _tpt.focusObserver.targets))
          _tpt.hop(_tpt.focusObserver.targets, r) &&
            (clearTimeout(_tpt.focusObserver.targets[r].timer),
            e - _tpt.focusObserver.timer >= _tpt.focusObserver.targets[r].delay
              ? _tpt.focusObserver.targets[r].callBack(
                  t,
                  _tpt.focusObserver.targets[r].id
                )
              : (function (e) {
                  _tpt.focusObserver.targets[e].timer = setTimeout(() => {
                    _tpt.focusObserver.targets[e].callBack(
                      t,
                      _tpt.focusObserver.targets[e].id
                    );
              ...
              if (_tpt.hop(_tpt.wrapObserver.targets, i)) {
                ...
                (s.lw === o.width && s.lh === o.height) ||
                  ...
                  (s.callback &&
                    ...
                    s.callback.kill(),
                    (s.callback = null)),
                  (s.callback = _tpt.gsap.to(
                    {},
                    { duration: 0.2, onComplete: t.bind(window, s.elem, s.id) }
                  ))),
                  (s.lw = o.width),
                  (s.lh = o.height);
              }
  ...
  (() => {
     ...
     */ var r,
      ...
      ut = function (t) {
        var e,
          r,
          n = t[0];
        if ((R(n) || S(n) || (t = [t]), !(e = (n._gsap || {}).harness))) {
      ...
      Lt = function (t, e) {
        ...
        if (
          ((e._time ||
            ...
            ((r = Pt(t.rawTime(), e)),
            (!e._dur || Wt(0, e.totalDuration(), r) - e._tTime > y) &&
              e.render(r, !0)),
      ...
      Nt = function (t, e, r, n) {
        return (
          e.parent && Tt(e),
          (e._start = ft(
            (M(r) ? r : r || t !== s ? Vt(t, r, e) : t._time) + e._delay
          )),
          (e._end = ft(
      ...
      It = function (t, e) {
        return (
          (G.ScrollTrigger || U("scrollTrigger", e)) &&
      ...
      Yt = function (t, e, r, n) {
        ...
        return (
          ...
          (t._dur = s),
          (t._tDur = i ? (i < 0 ? 1e10 : ft(s * (i + 1) + t._rDelay * i)) : s),
          ...
          ? ((s = r.charAt(0)),
            ...
            "<" === s || ">" === s
              ...
              : ((s = parseFloat(r.charAt(i - 1) + r.substr(i + 1))),
                o && n && (s = (s / 100) * (L(n) ? n[0] : n).totalDuration()),
      ...
      Jt = function (t, e, r) {
        return i && !e && i.selector
          ...
          ? L(t)
            ...
            ? [t]
            : []
          : Qt.call((e || u).querySelectorAll(t), 0);
      },
      Kt = function (t) {
        return (
          (t = Jt(t)[0] || W("Invalid scope") || {}),
          function (e) {
      ...
      ee = function (t) {
        ...
        return (
          T(n)
            ? (l = p = { center: 0.5, edges: 0.5, end: 1 }[n] || 0)
            : !o && a && ((l = n[0]), (p = n[1])),
          function (t, o, c) {
            var h,
              f,
            ...
            if (!w) {
              if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, v])[1])) {
                for (
                  D = -v;
                  D < (D = c[x++].getBoundingClientRect().left) && x < b;
              ...
              ? S(t)
                ...
                : function (e) {
                    for (
                      ...
                      (i = n
                        ? (i = t[p].x - o) * i + (s = t[p].y - a) * s
                        : Math.abs(t[p] - o)) < u && ((u = i), (l = p));
                    return (
                      (l = !r || u <= r ? t[l] : e),
                      n || l === e || M(e) ? l : l + $t(e)
                    );
      ...
      oe = function (t) {
        for (var e, r, n, i, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
          (n = t.indexOf(")", e)),
            (i = "[" === t.charAt(e + 7)),
            (r = t.substr(e + 7, n - e - 7).match(i ? Y : N)),
            (o +=
              t.substr(s, e - s) +
      ...
      _e = function (t, e, r) {
        var n,
          ...
          c,
          h,
          f = t ? (M(t) ? [t >> 16, (t >> 8) & fe, t & fe] : 0) : de.black;
        if (!f) {
          if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), de[t]))
            ...
            if (((f = h = t.match(N)), e)) {
              if (~t.indexOf("="))
                return (f = t.match(I)), r && f.length < 4 && (f[3] = 1), f;
            } else
              (o = (+f[0] % 360) / 360),
                (a = +f[1] / 100),
                (n =
        ...
        return (
          e &&
            ...
            (i = f[1] / fe),
            (s = f[2] / fe),
            (u = ((l = Math.max(n, i, s)) + (p = Math.min(n, i, s))) / 2),
            l === p
              ? (o = a = 0)
              : ((c = l - p),
                (a = u > 0.5 ? c / (2 - l - p) : c / (l + p)),
                (o =
                  l === n
                    ? (i - s) / c + (i < s ? 6 : 0)
                    : l === i
      ...
      De = function (t, e, r) {
        ...
        if (
          ...
          for (o = (i = t.replace(ve, "1").split(z)).length - 1; p < o; p++)
            a +=
              i[p] +
              (~n.indexOf(p)
                ? u.shift() || l + "0,0,0,0)"
          ...
          wake: function () {
            l &&
              (!a &&
                ...
                (u = o.document || {}),
                (G.gsap = xr),
                (o.gsapVersions || (o.gsapVersions = [])).push(xr.version),
      ...
      Te = function (t) {
        for (
          ...
          (r = s[a]),
            ...
            (n = r.substr(0, e)),
            (i[o] = isNaN(n) ? n.replace(Ee, "").trim() : +n),
            (o = r.substr(e + 1).trim());
        return i;
      },
      Se = function (t) {
        ...
        G.SteppedEase =
          {
            config: function (t, e) {
              ...
              var r = 1 / t,
                ...
                i = e ? 1 : 0;
              return function (t) {
                return (((n * Wt(0, 0.99999999, t)) | 0) + i) * r;
              };
            },
          }),
      (D.ease = Ce["quad.out"]),
        ...
        return (
          ...
          (e.totalTime = function (t, e) {
            ...
            if (r && r.smoothChildTiming && this._ts) {
              for (
                Bt(this, t), !r._dp || r.parent || Lt(r, this);
                r && r.parent;
          ...
          (e.timeScale = function (t, e) {
            ...
            return (
              ...
              this.totalTime(
                Wt(-Math.abs(this._delay), this._tDur, r),
                !1 !== e
              ),
              kt(this),
              (function (t) {
    ...
    var Ne = (function (r) {
      function i(e, n) {
        ...
        return (
          ...
          s && Nt(e.parent || s, t(i), n),
          e.reversed && i.reverse(),
          e.paused && i.paused(!0),
          e.scrollTrigger && It(t(i), e.scrollTrigger),
          i
        );
      }
      e(i, r);
      ...
      return (
        ...
        (o.set = function (t, e, r) {
          return (
            ...
            new We(t, e, Vt(this, r), 1),
            this
          );
        }),
        (o.call = function (t, e, r) {
          return Nt(this, We.delayedCall(0, t, e), r);
        }),
        ...
        (o.staggerFrom = function (t, e, r, n, i, s, o) {
          return (
            (r.runBackwards = 1),
            (Ct(r).immediateRender = O(r.immediateRender)),
        ...
        (o.staggerFromTo = function (t, e, r, n, i, s, o, a) {
          return (
            (n.startAt = r),
            (Ct(n).immediateRender = O(n.immediateRender)),
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  (m = w ? 0 : x % v ? v : x),
                  (this._lock = 1),
                  (this.render(m || (_ ? 0 : ft(u * l)), e, !v)._lock = 0),
                  (this._tTime = x),
            ...
            if (
              ...
              this._initted ||
                ...
                (this._zTime = t),
                (m = 0)),
              !m && i && !e && !u && (le(this, "onStart"), this._tTime !== x))
            )
              return this;
            if (i >= m && t >= 0)
              for (o = this._first; o; ) {
                if (
                  ((a = o._next), (o._act || i >= o._start) && o._ts && c !== o)
                ) {
              ...
              for (var F = t < 0 ? t : i; o; ) {
                if (
                  ((a = o._prev), (o._act || F <= o._end) && o._ts && c !== o)
                ) {
                  if (o.parent !== this) return this.render(t, e, r);
                  if (
                    (o.render(
            ...
            if (
              ...
              return (this._start = f), kt(this), this.render(t, e, r);
            this._onUpdate && !e && le(this, "onUpdate", !0),
              ((x === D && this._tTime >= this.totalDuration()) || (!x && m)) &&
                ((f !== this._start && Math.abs(h) === Math.abs(this._ts)) ||
                  this._lock ||
                  ((t || !v) &&
                    ((x === D && this._ts > 0) || (!x && this._ts < 0)) &&
                    Tt(this, 1),
                  e ||
                    (t < 0 && !m) ||
                    (!x && !m && D) ||
                    (le(
                      this,
                      x === D && t >= 0 ? "onComplete" : "onReverseComplete",
                      !0
                    ),
                    this._prom &&
                      !(x < D && this.timeScale() > 0) &&
                      this._prom())));
          }
          return this;
        }),
        ...
        (o.addPause = function (t, e, r) {
          var n = We.delayedCall(0, e || Q, r);
          return (
            (n.data = "isPause"), (this._hasPause = 1), Nt(this, n, Vt(this, t))
          );
        }),
        ...
        (o.getTweensOf = function (t, e) {
          for (var r, n = [], i = Jt(t), s = this._first, o = M(e); s; )
            s instanceof We
              ? gt(s._targets, i) &&
                (o
                  ? (!Ie || (s._initted && s._ts)) &&
            ...
            for (n = o.parent; a; )
              (e = a._prev),
                ...
                (r = a._start) > u && o._sort && a._ts && !o._lock
                  ? ((o._lock = 1), (Nt(o, a, r - a._delay, 1)._lock = 0))
                  : (u = r),
                r < 0 &&
                  a._ts &&
                  ((i -= r),
    ...
    yt(Ne.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
    var Ie,
      ze,
      Xe = function (t, e, r, n, i, s, o) {
        var a,
          u,
          l,
          p,
          ...
          f,
          d,
          g = new ur(this._pt, t, e, 0, 1, rr, null, i),
          _ = 0,
          m = 0;
        for (
          g.b = r,
      ...
      je = function (t, e, r, n, i, s, o, a, u, l) {
        ...
        if (
          ...
          return isNaN(h * n) || "" === n
            ? (!c && !(e in t) && U(e, n),
              Xe.call(this, t, e, h, n, f, a || m.stringFilter, u))
            : ((p = new ur(
                this._pt,
                t,
                e,
      ...
      Ye = function (t, e, r, n, i, s) {
        ...
        if (
            ...
            (o = new nt[t]()).init(
              ...
              o.rawVars
                ...
                : (function (t, e, r, n, i) {
                    if (
                      (S(t) && (t = Ve(t, i, e, r, n)),
                      !R(t) || (t.style && t.nodeType) || L(t) || B(t))
                    )
                      return T(t) ? Ve(t, i, e, r, n) : t;
                    var s,
                      o = {};
          ...
          ((r._pt = a = new ur(r._pt, i, t, 0, 1, o.render, o, 0, o.priority)),
          r !== c)
        )
          for (
      ...
      qe = function t(e, i, o) {
        ...
        if (
          (X && (!R || !C) && (C = "none"),
          (e._ease = Ae(C, D.ease)),
          (e._yEase = A ? Se(Ae(!0 === A ? C : A, D.ease)) : 0),
          A &&
            e._yoyo &&
            !e._repeat &&
            ((A = e._yEase), (e._yEase = e._ease), (e._ease = A)),
          (e._from = !X && !!w.runBackwards),
          !X || (R && !w.stagger))
        ) {
          if (
            ((x = (d = L[0] ? lt(L[0]).harness : 0) && w[d.prop]),
            (a = wt(w, tt)),
            B &&
            ...
            if (
              ...
              x && (l[d.prop] = x),
              Tt((e._startAt = We.set(L, l))),
              (e._startAt._dp = 0),
              (e._startAt._sat = e),
              i < 0 && (n ? e._startAt.revert(J) : e._startAt.render(-1, !0)),
              (e._zTime = i),
              E)
            ) {
              if (!i) return;
          ...
          for (
            e._pt = e._ptCache = 0, T = (k && O(T)) || (T && !k), u = 0;
            u < L.length;
            u++
          ) {
            if (
              ((f = (c = L[u])._gsap || ut(L)[u]._gsap),
              (e._ptLookup[u] = _ = {}),
              rt[f.id] && et.length && _t(),
              (m = I === L ? u : I.indexOf(c)),
              d &&
                !1 !== (g = new d()).init(c, x || a, e, m, I) &&
                ((e._pt = p =
                  new ur(e._pt, c, g.name, 0, 1, g.render, g, 0, g.priority)),
              ...
              for (l in a)
                nt[l] && (g = Ye(l, a, e, m, c, I))
                  ? g.priority && (h = 1)
                  : (_[l] = p =
                      je.call(e, c, l, "get", a[l], m, I, 0, w.stringFilter));
            e._op && e._op[u] && e.kill(c, e._op[u]),
              z &&
                e._pt &&
                ((Ie = e),
                s.killTweensOf(c, _, e.globalTime(i)),
                (b = !e.parent),
                (Ie = 0)),
              e._pt && T && (rt[f.id] = 1);
          }
    ...
    var We = (function (i) {
      function o(e, n, o, a) {
        ...
        var l,
          ...
          g,
          _,
          D = (u = i.call(this, a ? n : Ct(n)) || this).vars,
          v = D.duration,
          y = D.delay,
          x = D.immediateRender,
          b = D.stagger,
          ...
          if (
            ...
            for (p = 0; p < h; p++)
              ((c = wt(n, Ue)).stagger = 0),
                ...
                _ && xt(c, _),
                (d = A[p]),
                (c.duration = +Ve(v, t(u), p, d, A)),
                (c.delay = (+Ve(y, t(u), p, d, A) || 0) - u._delay),
                !b &&
                  1 === h &&
                  c.delay &&
                  ((u._delay = y = c.delay), (u._start += y), (c.delay = 0)),
                l.to(d, c, g ? g(p, d, A) : 0),
                (l._ease = Ce.none);
            l.duration() ? (v = y = 0) : (u.timeline = 0);
          } else if (C) {
            Ct(yt(l.vars.defaults, { ease: "none" })),
            ...
            if (L(C))
              ...
              for (f in ((c = {}), C))
                "ease" === f || "easeEach" === f || Ge(f, C[f], c, C.easeEach);
              for (f in c)
                for (
        ...
        return (
          !0 !== w || r || ((Ie = t(u)), s.killTweensOf(A), (Ie = 0)),
          Nt(S, t(u), o),
          ...
          if (g) {
            if (
              ...
              if (((i = m), (c = this.timeline), this._repeat)) {
                if (((a = g + this._rDelay), this._repeat < -1 && _))
                  return this.totalTime(100 * a + t, e, r);
                if (
                  ((i = ft(m % a)),
                  m === d
                    ? ((o = this._repeat), (i = g))
                    : ((o = ~~(m / a)) && o === ft(m / a) && ((i = g), o--),
                      i > g && (i = g)),
                  (l = this._yoyo && 1 & o) && ((h = this._yEase), (i = g - i)),
                  (u = Ot(this._tTime, a)),
                  i === f && !r && this._initted && o === u)
                )
                  return (this._tTime = m), this;
                o !== u &&
                  (c && this._yEase && Me(c, l),
                  this.vars.repeatRefresh &&
                    !l &&
                    !this._lock &&
                    this._time !== a &&
              ...
              if (
                ...
                (this.ratio = p = (h || this._ease)(i / g)),
                this._from && (this.ratio = p = 1 - p),
                i && !f && !e && !o && (le(this, "onStart"), this._tTime !== m))
              )
                return this;
              ...
              (c &&
                ...
                this._onUpdate &&
                  !e &&
                  (_ && Mt(this, t, 0, r), le(this, "onUpdate")),
                this._repeat &&
                  o !== u &&
                  this.vars.onRepeat &&
                  !e &&
                ...
                (m !== this._tDur && m) ||
                  this._tTime !== m ||
                  (_ && !this._onUpdate && Mt(this, t, 0, !0),
                  (t || !g) &&
                  ...
                  e ||
                    (_ && !f) ||
                    !(m || f || l) ||
                    (le(this, m === d ? "onComplete" : "onReverseComplete", !0),
                    this._prom &&
            ...
            !(function (t, e, r, i) {
              ...
              if (
                ...
                e < 0 && Mt(t, e, 0, !0),
                  ...
                  c && t._repeat && !r && t.parent && le(t, "onRepeat"),
                  (e >= t._tDur || e < 0) &&
                    t.ratio === l &&
                    (l && Tt(t, 1),
                    r ||
                ...
                for (
                  ...
                  if (!u)
                    return (
                      ...
                      qe(t, o),
                      (ze = 0),
                      a ? W(e + " not eligible for reset") : 1
                    );
                  h.push(u);
                }
              for (c = h.length; c--; )
        ...
        (a.kill = function (t, e) {
          ...
          for (
            ...
            if (~c.indexOf(p[l]))
              ...
              o))
                (u = i && i[a]) &&
                  (("kill" in u.d && !0 !== u.d.kill(a)) || Et(this, u, "_pt"),
                  delete i[a]),
                  "all" !== s && (s[a] = 1);
              ...
              (t
                ? (function () {
                    ...
                    for (
                      ...
                      (e = r.data[i]) instanceof Ne
                        ? "nested" !== e.data &&
                          (e.scrollTrigger && e.scrollTrigger.revert(),
                          e.kill())
                        : !(e instanceof We) && e.revert && e.revert(t);
        ...
        return (
          (e.add = function (t, e, r) {
            ...
            var n,
              ...
              l = (u.conditions = {});
            for (s in (i && !u.selector && (u.selector = i.selector),
            ...
            t))
              "all" === s
                ? (a = 1)
                : (n = o.matchMedia(t[s])) &&
                  (lr.indexOf(u) < 0 && lr.push(u),
                  (l[s] = n.matches) && (a = 1),
                  n.addListener
                    ? n.addListener(gr)
                    : n.addEventListener("change", gr));
            return (
              a &&
                e(u, function (t) {
                  return u.add(null, t);
          ...
          (n || "").split(",").forEach(function (t) {
            ...
            s &&
              (Ne.prototype[e] = function (t, r, n) {
                return this.add(it[e](t, R(r) ? r : (n = r) && {}, this), n);
              });
        },
          ...
          interpolate: function t(e, r, n, i) {
            ...
            if (!s) {
              ...
              if ((!0 === n && (i = 1) && (n = null), c))
                ...
                for (u = [], l = e.length, p = l - 2, a = 1; a < l; a++)
                  u.push(t(e[a - 1], e[a]));
                l--,
                  (s = function (t) {
                    t *= l;
    ...
    (We.version = Ne.version = xr.version = "3.12.5"),
      (l = 1),
      P() && we(),
      Ce.Power0,
      Ce.Power1,
    ...
    var br,
      ...
      Jr = function t(e, r) {
        ...
        if (e in Ar && s) {
          if (((this.tfm = this.tfm || {}), "transform" === e))
            return Nr.transform.split(",").forEach(function (e) {
              return t.call(n, e, r);
            });
          if (
            (~(e = Nr[e] || e).indexOf(",")
              ...
              : (this.tfm[e] = o.x ? o[e] : mn(i, e)),
            e === Zr && (this.tfm.zOrigin = o.zOrigin),
      ...
      en = function (t, e) {
        var r = { target: t, props: [], revert: tn, save: Jr };
        return (
          ...
          e in Ar && e !== Zr && (e = Qr),
            n.removeProperty
              ? (("ms" !== (r = e.substr(0, 2)) &&
                  ...
                  (e = "-" + e),
                n.removeProperty(
                  "--" === r ? e : e.replace(kr, "-$1").toLowerCase()
                ))
              : n.removeAttribute(e);
        }
      },
      ...
      _n = function t(e, r, n, i) {
        ...
        if (
          ((c[h ? "width" : "height"] = g + (_ ? p : i)),
          (o =
            ~r.indexOf("adius") || ("em" === i && e.appendChild && !f)
              ? e
              : e.parentNode),
          ...
          return ht((l / a.width) * g);
        if (!m || ("height" !== r && "width" !== r))
          (m || "%" === p) &&
            !gn[nn(o, "display")] &&
            (c.position = nn(e, "position")),
      ...
      Dn = function (t, e, r, n) {
        if (!r || "none" === r) {
          ...
          s && s !== r
            ? ((e = i), (r = s))
            : "borderColor" === e && (r = nn(t, "borderTopColor"));
        }
        var o,
          a,
          u,
          ...
          g,
          _,
          D = new ur(this._pt, t.style, e, 0, 1, rr),
          v = 0,
          y = 0;
        if (
          ((D.b = r),
          ...
          for (; (a = z.exec(n)); )
            (h = a[0]),
              ...
              h !== (c = u[y++] || "") &&
                ((l = parseFloat(c) || 0),
                (_ = c.substr((l + "").length)),
                "=" === h.charAt(1) && (h = dt(l, h) + _),
                (f = parseFloat(h)),
                (g = h.substr((f + "").length)),
                (v = z.lastIndex - g.length),
                g ||
                  ((g = g || m.units[e] || _),
                  v === n.length && ((n += g), (D.e += g))),
                _ !== g && (l = _n(t, e, c, g) || 0),
                (D._pt = {
                  _next: D._pt,
                  p: d || 1 === y ? d : ",",
        ...
        if (e.tween && e.tween._time === e.tween._dur) {
          ...
          if ("all" === a || !0 === a) (o.cssText = ""), (n = 1);
            ...
            for (i = (a = a.split(",")).length; --i > -1; )
              (r = a[i]),
                Ar[r] && ((n = 1), (r = "transformOrigin" === r ? Zr : Qr)),
                hn(s, r);
          n &&
            (hn(s, Qr),
            u &&
      ...
      Tn = function (t, e, r, n, i, s) {
        ...
        r
          ? p !== bn &&
            (a = g * D - _ * m) &&
            ((u = b * (-_ / a) + w * (g / a) - (g * y - _ * v) / a),
            (b = b * (D / a) + w * (-m / a) + (m * y - D * v) / a),
            (w = u))
          : ((b =
              (o = pn(t)).x + (~x[0].indexOf("%") ? (b / 100) * o.width : b)),
            (w =
              o.y + (~(x[1] || x[0]).indexOf("%") ? (w / 100) * o.height : w))),
          n || (!1 !== n && l.smooth)
            ? ((v = b - c),
              (y = w - h),
              (l.xOffset = f + (v * g + y * m) - v),
              (l.yOffset = d + (v * _ + y * D) - y))
          ...
          s &&
            (fn(s, l, "xOrigin", c, b),
            fn(s, l, "yOrigin", h, w),
            fn(s, l, "xOffset", f, l.xOffset),
            fn(s, l, "yOffset", d, l.yOffset)),
      ...
      Sn = function (t, e) {
        ...
        return (
          ...
          r.svg &&
            (r.uncache
              ? ((S = t.getBBox()),
                (j = r.xOrigin - S.x + "px " + (r.yOrigin - S.y) + "px"),
                (T = ""))
              : (T = !e && t.getAttribute("data-svg-origin")),
            Tn(t, T || j, !!T || r.originIsAbsolute, !1 !== r.smooth, _)),
          (d = r.xOrigin || 0),
          (g = r.yOrigin || 0),
          _ !== bn &&
            ((x = _[0]),
            ...
            6 === _.length
              ? ((o = Math.sqrt(x * x + b * b)),
                ...
                (u = x || b ? Pr(b, x) * Rr : 0),
                (c = w || C ? Pr(w, C) * Rr + u : 0) &&
                  (a *= Math.abs(Math.cos(c * Or))),
                r.svg &&
                  ((n -= d - (d * x + g * w)), (i -= g - (d * b + g * C))))
              : ((B = _[6]),
                (P = _[7]),
                (A = _[8]),
                (R = _[9]),
                ...
                (l = (D = Pr(B, O)) * Rr),
                D &&
                  ((T = F * (v = Math.cos(-D)) + A * (y = Math.sin(-D))),
                  (S = E * v + R * y),
                  (M = B * v + O * y),
                  (A = F * -y + A * v),
                  (R = E * -y + R * v),
                ...
                D &&
                  ((v = Math.cos(-D)),
                  (k = C * (y = Math.sin(-D)) + k * v),
                  (x = T = x * v - A * y),
                  (b = S = b * v - R * y),
                  (w = M = w * v - O * y)),
                (u = (D = Pr(b, x)) * Rr),
                D &&
                  ((T = x * (v = Math.cos(D)) + b * (y = Math.sin(D))),
                  (S = F * v + E * y),
                  (b = b * v - x * y),
                  (E = E * v - F * y),
                  (x = T),
                ...
                l &&
                  ...
                  ((l = u = 0), (p = 180 - p)),
                (o = ht(Math.sqrt(x * x + b * b + w * w))),
                (a = ht(Math.sqrt(E * E + B * B))),
                (D = Pr(F, E)),
                (c = Math.abs(D) > 2e-4 ? D * Rr : 0),
                (f = k ? 1 / (k < 0 ? -k : k) : 0)),
            r.svg &&
              ((T = t.getAttribute("transform")),
              (r.forceCSS = t.setAttribute("transform", "") || !Cn(nn(t, Qr))),
          ...
          (r.force3D = m.force3D),
          (r.renderTransform = r.svg ? Ln : Mr ? Bn : Rn),
          (r.uncache = 0),
          r
        );
      },
      ...
      Bn = function (t, e) {
        ...
        if (D && (p !== On || l !== On)) {
          ...
          (b = parseFloat(p) * Or),
            (x = Math.cos(b)),
            (s = An(m, s, w * x * -D)),
            (o = An(m, o, -Math.sin(b) * -D)),
            (a = An(m, a, C * x * -D + D));
        }
        g !== Pn && (v += "perspective(" + g + kn),
          (n || i) && (v += "translate(" + n + "%, " + i + "%) "),
          (y || s !== Pn || o !== Pn || a !== Pn) &&
            (v +=
              a !== Pn || y
          ...
          l !== On && (v += "rotateY(" + l + kn),
          p !== On && (v += "rotateX(" + p + kn),
          (c === On && h === On) || (v += "skew(" + c + ", " + h + kn),
          (1 === f && 1 === d) || (v += "scale(" + f + ", " + d + kn),
          (m.style[Qr] = v || "translate(0, 0)");
      },
      Ln = function (t, e) {
        var r,
          n,
        ...
        (h = parseFloat(h)),
          (f = parseFloat(f)),
          (d = parseFloat(d)) && ((f += d = parseFloat(d)), (h += d)),
          h || f
            ? ((h *= Or),
              (f *= Or),
              (r = Math.cos(h) * g),
          ...
          ((w && !~(p + "").indexOf("px")) ||
            (C && !~(c + "").indexOf("px"))) &&
            ((w = _n(m, "x", p, "px")), (C = _n(m, "y", c, "px"))),
          (D || v || y || x) &&
            ((w = ht(w + D - (D * r + v * i) + y)),
            (C = ht(C + v - (D * n + v * s) + x))),
          (u || l) &&
            ((o = m.getBBox()),
            (w = ht(w + (u / 100) * o.width)),
            (C = ht(C + (l / 100) * o.height))),
          (o =
            "matrix(" +
            r +
            "," +
      ...
      Nn = function (t, e, r, n, i) {
        ...
        return (
          ...
          (t._pt = o = new ur(t._pt, e, r, n, l, zr)),
          (o.e = p),
          (o.u = "deg"),
          t._props.push(r),
          o
      ...
      zn = function (t, e, r) {
        ...
        Ar))
          (s = p[i]) !== (o = n[i]) &&
            ...
            (u = parseFloat(o)),
            (t._pt = new ur(t._pt, n, i, a, u - a, Ir)),
            (t._pt.u = l || 0),
            t._props.push(i));
        In(n, p);
      };
      ...
      Yn = {
        ...
        init: function (t, e, r, n, i) {
          ...
          e))
            if (
              "autoRound" !== c &&
              ((o = e[c]), !nt[c] || !Ye(c, e, r, n, t, i))
            )
              if (
                ((l = typeof o),
                (p = xn[c]),
                "function" === l && (l = typeof (o = o.call(r, n, t, i))),
                "string" === l && ~o.indexOf("random(") && (o = oe(o)),
                p)
              )
                p(this, t, c, o, r) && (y = 1);
                ...
                (s = (getComputedStyle(t).getPropertyValue(c) + "").trim()),
                  (o += ""),
                  (ve.lastIndex = 0),
                  ve.test(s) || ((h = $t(s)), (f = $t(o))),
                  f ? h !== f && (s = _n(t, c, s, f) + f) : h && (o += h),
                  this.add(S, "setProperty", s, o, n, i, 0, 0, c),
                  E.push(c),
                  x.push(c, 0, S[c]);
              else if ("undefined" !== l) {
                if (
                  (M && c in M
                    ? ((s =
                        "function" == typeof M[c]
                          ? M[c].call(r, n, t, i)
                          : M[c]),
                      T(s) && ~s.indexOf("random(") && (s = oe(s)),
                      $t(s + "") ||
                        "auto" === s ||
                        (s += m.units[c] || $t(mn(t, c)) || ""),
                      "=" === (s + "").charAt(1) && (s = mn(t, c)))
                    : (s = mn(t, c)),
                  (u = parseFloat(s)),
                  (d =
                  ...
                  if (
                    ...
                    (this._pt = new ur(
                      ...
                      "scaleY",
                      D.scaleY,
                      (d ? dt(D.scaleY, d + a) : a) - D.scaleY || 0,
                      Ir
                    )),
                      (this._pt.u = 0),
                      E.push("scaleY", c),
                      ...
                      x.push(Zr, 0, S[Zr]),
                        ...
                        D.svg
                          ...
                          : ((f = parseFloat(o.split(" ")[2]) || 0) !==
                              D.zOrigin && fn(this, D, "zOrigin", D.zOrigin, f),
                            fn(this, S, c, Mn(s), Mn(o)));
                      continue;
                    }
                    if ("svgOrigin" === c) {
                      Tn(t, o, 1, v, 0, this);
                ...
                if (
                  g ||
                  ((a || 0 === a) && (u || 0 === u) && !Lr.test(o) && c in S)
                )
                  a || (a = 0),
                    (h = (s + "").substr((u + "").length)) !==
                      (f = $t(o) || (c in m.units ? m.units[c] : h)) &&
                      (u = _n(t, c, s, f)),
                    (this._pt = new ur(
                      this._pt,
                      g ? D : S,
                ...
                g || (c in S ? x.push(c, 0, S[c]) : x.push(c, 1, s || t[c])),
                  E.push(c);
              }
          y && ar(this);
        },
        ...
        core: { _removeProperty: hn, _getMatrix: En },
      };
    (xr.utils.checkPrefix = on),
      (xr.core.getStyleSaver = en),
      (jn = ct(
      ...
      (Nr[jn[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Xn),
      ct(
     ...
     */ var Un,
      ...
      ri = function (t) {
        (Un = document),
          ...
          (Qn =
            ...
            ((Jn = Qn.utils.toArray),
            (Zn = Qn.core.context || function () {}),
            ($n = 1));
      },
      ni = function (t) {
        return Wn.getComputedStyle(t);
      },
      ii = function (t) {
      ...
      hi = function (t, e, r, n, i, s, o) {
        var a,
          ...
          E = ci("fontSize", v) * (e.lineThreshold || 0.2),
          T = v.textAlign,
          S = [],
          M = [],
          A = [],
            ...
            ((h = (p = c[a]).parentNode === t) || N || (L && !B)) &&
              ...
              k &&
                (((p._isSplit && h) ||
                  ...
                  (f.push(p), (p._x -= y), li(p, t, R) && (p._wordEnd = !0)),
                "BR" === p.nodeName &&
        ...
        for (a = 0; a < l; a++)
          if (((h = (p = c[a]).parentNode === t), "BR" !== p.nodeName))
            if (
              ...
              if (p._isSplit)
                for (
                  p._next = u = p.nextSibling, p.parentNode.appendChild(p);
                ...
                p.parentNode._isSplit
                  ? ((p._parent = p.parentNode),
                    ...
                    l--)
                  : h ||
                    ((D = !p.nextSibling && li(p.parentNode, t, R)),
                    p.parentNode._parent && p.parentNode._parent.appendChild(p),
                    D && p.parentNode.appendChild(Un.createTextNode(" ")),
                    "span" === O && (p.style.display = "inline"),
                    S.push(p));
            else
              p.parentNode._isSplit && !p._isSplit && "" !== p.innerHTML
                ...
                : L &&
                  !p._isSplit &&
                  ("span" === O && (p.style.display = "inline"), S.push(p));
          else
            k || N
        ...
        if (k) {
          for (
            N &&
              ((_ = Un.createElement(O)),
              t.appendChild(_),
              (m = _.offsetWidth + "px"),
              (D = _.offsetParent === t ? 0 : t.offsetLeft),
              t.removeChild(_)),
              g = t.style.cssText,
          ...
          for (d = " " === R && (!N || (!B && !L)), a = 0; a < k.length; a++) {
            for (
              f = k[a],
                (_ = Un.createElement(O)).style.cssText =
                  "display:block;text-align:" +
                  T +
                  ";position:" +
                  (N ? "absolute;" : "relative;"),
                I && (_.className = I + (z ? a + 1 : "")),
                A.push(_),
                l = f.length,
                u = 0;
              u < l;
              ...
              "BR" !== f[u].nodeName &&
                ((p = f[u]),
                _.appendChild(p),
                d && p._wordEnd && _.appendChild(Un.createTextNode(" ")),
                N &&
                  (0 === u &&
                    ((_.style.top = p._y + "px"),
                    (_.style.left = y + D + "px")),
                  (p.style.top = "0px"),
                  D && (p.style.left = p._x - D + "px")));
            0 === l
              ? (_.innerHTML = "&nbsp;")
              : B || L || (pi(_), ai(_, String.fromCharCode(160), " ")),
              N && ((_.style.width = m), (_.style.height = p._h + "px")),
              t.appendChild(_);
          }
          t.style.cssText = g;
        }
        N &&
          ...
          s > t.clientWidth &&
            ((t.style.width = s - F + "px"),
            t.clientWidth < s && (t.style.width = s + w + "px"))),
          j && (Y ? (t.style.display = Y) : t.style.removeProperty("display")),
          ui(r, S),
          B && ui(n, M),
          ui(i, A);
      },
        ...
        var i,
          ...
          y = e.specialChars
            ? "function" == typeof e.specialChars
              ...
              : si
            : null,
          x = Un.createElement("div"),
          b = t.parentNode;
        for (
          b.insertBefore(x, t),
            x.textContent = t.nodeValue,
            b.removeChild(t),
            p = -1 !== (i = Hn((t = x))).indexOf("<"),
            !1 !== e.reduceWhiteSpace &&
              (i = i.replace(ti, " ").replace(Kn, "")),
            p && (i = i.split("<").join("{{LT}}")),
            u = i.length,
            s = (" " === i.charAt(0) ? m : "") + r(),
            o = 0;
          ...
          if (((l = i.charAt(o)), y && (c = y(i.substr(o), e.specialChars))))
            (l = i.substr(o, c || 1)),
              (s += f && " " !== l ? n() + l + "</" + h + ">" : l),
              (o += c - 1);
          ...
          (e.split = function (t) {
            ...
            for (
              ...
              (n = this.elements[i]),
                ...
                (r = n.clientWidth),
                di(n, t, o, a),
                hi(n, t, this.chars, this.words, this.lines, r, e);
            return (
              this.chars.reverse(),
              this.words.reverse(),
              this.lines.reverse(),
    ...
    var _i = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
      ...
      Oi = 1e5,
      Pi = function (t) {
        return Math.round(((t + Ti) % 1) * Oi) / Oi || (t < 0 ? 0 : 1);
      },
      ki = function (t) {
        return Math.round(t * Oi) / Oi || 0;
      },
      Bi = function (t) {
      ...
      Li = function (t, e, r, n) {
        ...
        if ((s || !n) && s + r + 2 < i.length)
          return t.splice(e, 0, i.slice(0, r + s + 2)), i.splice(0, r + s), 1;
      },
      Ni = function (t, e, r) {
        var n = t.length,
          i = ~~(r * n);
    ...
    function Xi(t) {
      var e,
        r = (t = (Si(t) && vi.test(t) && document.querySelector(t)) || t)
          .getAttribute
          ? t
          : 0;
      return r && (t = t.getAttribute("d"))
        ? (r._gsPath || (r._gsPath = {}),
          (e = r._gsPath[t]) && !e._dirty ? e : (r._gsPath[t] = Ji(t)))
        : t
        ? Si(t)
          ? Ji(t)
          : Mi(t[0])
    ...
    function qi(t, e, r) {
      ...
      return (
        ...
        (i += ((s = t[e + 3]) - i) * r),
        (i += ((s += ((o = t[e + 5]) - s) * r) - i) * r),
        ki(Ei(s + (o + (t[e + 7] - o) * r - s) * r - i, n) * xi)
      );
    }
    function Gi(t, e, r) {
      ...
      if (d || n) {
        for (
          o = v < y || (w && x < b) || (C && _.t < g.t),
            Li(i, y, b, g.t) &&
              (y++,
              o ||
                (v++,
                C
                  ? ((_.t = (_.t - g.t) / (1 - g.t)), (x = 0))
                  : w && (x -= b))),
            Math.abs(1 - (r - e)) < 1e-5
              ? (v = y - 1)
              : !_.t && v
          ...
          zi(p, i[f++ % c]);
        i = p;
      } else if (((u = 1 === _.t ? 6 : Ui(m, x, _.t)), e !== r))
        for (
          a = Ui(D, b, C ? g.t / _.t : g.t),
            w && (u += a),
            m.splice(x + u + 2),
            (a || b) && D.splice(0, b + a),
            l = i.length;
    ...
    function Vi(t, e, r) {
      ...
      for (E.length = T.length = 0, i = e + 2; i < b; i += 6) {
        if (
          ...
          (h = t[i + 1] - C),
          (u = l = f = d = 0),
          Ci(s) < 0.01 && Ci(p) < 0.01 && Ci(a) + Ci(h) < 0.01)
        )
          t.length > 8 && (t.splice(i, 6), (i -= 6), (b -= 6));
        else
          for (n = 1; n <= y; n++)
            (u =
              l -
              (l =
                ((_ = x * n) * _ * s + 3 * (g = 1 - _) * (_ * o + g * a)) * _)),
              (f = d - (d = (_ * _ * p + 3 * g * (_ * c + g * h)) * _)),
              (D = Fi(f * f + u * u)) < S && (S = D),
              (A += D),
              (E[F++] = A);
        (w += s), (C += p);
      }
      if (M) for (M -= A; F < E.length; F++) E[F] += M;
      if (E.length && S) {
        if (
          ((t.totalLength = v = E[E.length - 1] || 0),
          (t.minLength = S),
          v / S < 9999)
        )
    ...
    function Hi(t, e) {
      ...
      for (i = r = n = 0; i < t.length; i++)
        (t[i].resolution = ~~e || 12), (n += t[i].length), (r += Vi(t[i]));
        ...
        if (1 === e) (p = 1), (l = (h = t[(c = t.length - 1)]).length - 8);
          ...
          (i = h.samples),
            ...
            n &&
              ...
              (l + 6 < h.length
                ? ((l += 6), (p = 0))
                : c + 1 < t.length && ((l = p = 0), (h = t[++c])));
        }
      else (p = l = c = 0), (h = t[0]);
      return (
        (r.t = p), (r.i = l), (r.path = t), (r.segment = h), (r.segIndex = c), r
      );
    }
    function $i(t, e, r, n) {
      var i,
      ...
      if (((e < 0 || e > 1) && (e = Pi(e)), f.lookup || Hi(t), t.length > 1)) {
        for (o = t.totalLength * e, u = l = 0; (u += t[l++].totalLength) < o; )
          f = t[l];
      ...
      return (
        ...
        (a = (l = f.lookup.length
          ...
          : 0),
        (u = i[l]) < o && ((a = u), (u = i[++l])),
        (h = 1 - (p = (1 / s) * ((o - a) / (u - a) + (l % s)) || 0)),
        (c = f[(l = 6 * ~~(l / s))]),
        (d.x = ki(
          (p * p * (f[l + 6] - c) +
            3 * h * (p * (f[l + 4] - c) + h * (f[l + 2] - c))) *
            p +
            c
        )),
        (d.y = ki(
          (p * p * (f[l + 7] - (c = f[l + 1])) +
            3 * h * (p * (f[l + 5] - c) + h * (f[l + 3] - c))) *
            p +
            c
        )),
        r &&
          (d.angle = f.totalLength
            ? qi(f, l, p >= 1 ? 1 - 1e-9 : p || 1e-9)
            : f.angle || 0),
        d
      );
    }
    ...
    function Zi(t, e, r, n, i, s, o, a, u) {
      if (t !== a || e !== u) {
        ...
        var C = (s === o ? -1 : 1) * Fi(w),
          ...
          B =
            (M * O - A * R < 0 ? -1 : 1) *
            Math.acos((M * R + A * O) / Fi(P * (R * R + O * O)));
        isNaN(B) && (B = h),
          !o && B > 0 ? (B -= f) : o && B < 0 && (B += f),
          (k %= f),
          (B %= f);
        var L,
          N = Math.ceil(Ci(B) / (f / 4)),
          I = [],
          z = B / N,
        ...
        for (L = 0; L < N; L++)
          (_ = wi((i = k + L * z))),
            ...
            (M = wi((i += z))),
            (A = bi(i)),
            I.push(_ - X * m, m + X * _, M + X * A, A - X * M, M, A);
    ...
    function Ji(t) {
      var e,
        ...
        C = function (t, e, r, n) {
          (p = (r - t) / 3),
            (c = (n - e) / 3),
            a.push(t + p, e + c, r - p, n - c, r, n);
        };
      if (!t || !isNaN(_[0]) || isNaN(_[1])) return console.log(w), m;
      for (e = 0; e < x; e++)
        if (
          ((f = s),
          isNaN(_[e]) ? (o = (s = _[e].toUpperCase()) !== _[e]) : e--,
          (n = +_[e + 1]),
          (i = +_[e + 2]),
          o && ((n += D), (i += v)),
          e || ((u = n), (l = i)),
          ...
          (p = D),
            (c = v),
            ("C" !== f && "S" !== f) ||
              ((p += D - a[a.length - 4]), (c += v - a[a.length - 3])),
            o || (D = v = 0),
            a.push(p, c, n, i, (D += 1 * _[e + 3]), (v += 1 * _[e + 4])),
            (e += 4);
        else if ("Q" === s)
          (p = D + (n - D) * y),
            (c = v + (i - v) * y),
            ...
            (D += 1 * _[e + 3]),
            (v += 1 * _[e + 4]),
            a.push(p, c, D + (n - D) * y, v + (i - v) * y, D, v),
            (e += 4);
        else if ("T" === s)
          (p = D - a[a.length - 4]),
            (c = v - a[a.length - 3]),
          ...
          "Z" === s && ((n = u), (i = l), (a.closed = !0)),
            ("L" === s || Ci(D - n) > 0.5 || Ci(v - i) > 0.5) &&
              (C(D, v, n, i), "L" === s && (e += 2)),
            (D = n),
            (v = i);
        else if ("A" === s) {
    ...
    function ts(t, e) {
      ...
      var r,
        ...
        b = v - m,
        w = y - D,
        C = Math.abs(t[_] - m) < 0.001 && Math.abs(t[_ + 1] - D) < 0.001;
      for (
        C &&
          (t.push(v, y),
          (v = m),
        ...
        (r = m),
          ...
          (m === v && D === y) ||
            ...
            (w = y - D),
            (l =
              (((a = Fi(s * s + o * o)) + (u = Fi(b * b + w * w))) * e * 0.25) /
              Fi(Math.pow(b / u + s / a, 2) + Math.pow(w / u + o / a, 2))),
            (h =
              m -
              ((p = m - (m - r) * (a ? l / a : 0)) +
                ((((c = m + (v - m) * (u ? l / u : 0)) - p) *
            ...
            (g =
              ...
              ((f = D - (D - n) * (a ? l / a : 0)) +
                ((((d = D + (y - D) * (u ? l / u : 0)) - f) *
                  ...
                  4 || 0))),
            (m === r && D === n) ||
              x.push(ki(p + h), ki(f + g), ki(m), ki(D), ki(c + h), ki(d + g)));
      return (
        m !== v || D !== y || x.length < 4
          ? x.push(ki(v), ki(y), ki(v), ki(y))
          : (x.length -= 2),
        2 === x.length
          ? x.push(m, D, m, D, m, D)
          : C && (x.splice(0, 6), (x.length = x.length - 6)),
        x
      );
    }
    function es(t) {
     ...
     */ var rs,
      ...
      ss = function () {
        (rs = is())
          ? (rs.registerEase("_CE", ps.create), (ns = 1))
      ...
      ls = function t(e, r, n, i, s, o, a, u, l, p, c) {
        ...
        return (
          p ||
            ...
            (c = 1)),
          p.splice(c || p.length - 1, 0, { x: w, y: C }),
          (T + S) * (T + S) > l * (F * F + E * E) &&
            ((h = p.length),
            t(e, r, f, d, v, y, w, C, l, p, c),
            t(w, C, x, b, m, D, a, u, l, p, c + 1 + (p.length - h))),
          p
        );
      },
      ps = (function () {
        ...
        return (
          (e.setData = function (t, e) {
            ...
            if (
              ((this.data = t),
              (us.test(t) || (~t.indexOf("M") && t.indexOf("C") < 0)) &&
                (c = Ji(t)[0]),
              4 === (r = c.length))
            )
              c.unshift(0, 0), c.push(1, 1), (r = 8);
              ...
              (u = f[s]),
                ...
                u.x <= 1
                  ? ((l.cx = u.x - l.x),
                    ...
                    _ &&
                      s > 1 &&
                      Math.abs(l.cy / l.cx - f[s - 2].cy / f[s - 2].cx) > 2 &&
                      (_ = 0),
                    l.cx < h &&
                      (l.cx
                        ? (h = l.cx)
            ...
            if (((o = 1 / (r = (1 / h + 1) | 0)), (a = 0), (u = f[0]), _)) {
              for (s = 0; s < r; s++)
                (p = s * o),
                  u.nx < p && (u = f[++a]),
                  (n = u.y + ((p - u.x) / u.cx) * u.cy),
                  (d[s] = { x: p, cx: o, y: n, cy: 0, nx: 9 }),
            ...
            return (
              ...
              this.id && rs && rs.registerEase(this.id, this.ease),
              this
            );
          }),
          ...
          (t.getSVGData = function (e, r) {
            ...
            if (
              (r.invert && ((d = -d), (_ = 0)),
              "string" == typeof e && (e = rs.parseEase(e)),
              e.custom && (e = e.custom),
              e instanceof t)
            )
              n = es(Qi([e.segment], f, 0, 0, -d, g, _));
            else {
              for (
                n = [g, _],
                  o = 1 / (l = Math.max(5, 200 * (r.precision || 1))),
                  p = 5 / (l += 2),
                  c = os(g + o * f),
                  i = ((h = os(_ + e(o) * -d)) - _) / (c - g),
                  s = 2;
                s < l;
                s++
              )
                (a = os(g + s * o * f)),
                  (u = os(_ + e(s * o) * -d)),
                  (Math.abs((u - h) / (a - c) - i) > p || s === l - 1) &&
                    (n.push(c, h), (i = (u - h) / (a - c))),
                  (c = a),
                  (h = u);
              n = "M" + n.join(",");
            }
    ...
    var cs,
      ...
      Ss = function (t, e, r, n, i, s) {
        return Ts(
          Math.pow((Cs(r) - Cs(t)) * i, 2) + Math.pow((Cs(n) - Cs(e)) * s, 2)
        );
      },
      Ms = function (t) {
      ...
      Rs = function (t) {
        ...
        As(t) &&
          ((c = t.getScreenCTM()),
          (p = Ts(c.a * c.a + c.b * c.b)),
          (c = Ts(c.d * c.d + c.c * c.c)));
        try {
          r = t.getBBox();
        } catch (t) {
          Ms(
        ...
        var h = r || { x: 0, y: 0, width: 0, height: 0 },
          f = h.x,
          d = h.y,
          g = h.width,
          _ = h.height;
        if (
          ...
          for (
            n = t.getAttribute("points").match(xs) || [],
            ...
            e += Ss(n[s - 2], n[s - 1], n[s], n[s + 1], p, c) || 0;
        else
          ("circle" !== u && "ellipse" !== u) ||
            ((o = (g / 2) * p),
            (a = (_ / 2) * c),
            (e = Math.PI * (3 * (o + a) - Ts((3 * o + a) * (o + 3 * a)))));
        return e || 0;
      },
      Os = function (t, e) {
      ...
      Ps = function () {
        vs() &&
          ...
          (gs = cs = ys()),
          (hs = cs.utils.toArray),
          (ms = cs.core.getStyleSaver),
          (Ds = cs.core.reverting || function () {}),
          (ds = -1 !== ((fs.navigator || {}).userAgent || "").indexOf("Edge")));
      },
      ks = {
        version: "3.12.5",
        name: "drawSVG",
        ...
        init: function (t, e, r, n, i) {
          ...
          return (
            (this.styles =
              ms && ms(t, "strokeDashoffset,strokeDasharray,strokeMiterlimit")),
            (this.tween = r),
            (this._style = t.style),
            (this._target = t),
            e + "" == "true"
            ...
            (o = (function (t, e, r) {
              ...
              return (
                s < 0
                  ? ((n = void 0 !== r ? r + "" : t), (i = t))
                  : ((n = t.substr(0, s)), (i = t.substr(s + 1))),
                (n = Fs(n, e)) > (i = Fs(i, e)) ? [i, n] : [n, i]
              );
            })(e, u, (s = Os(t, u))[0])),
            (this._length = ws(u)),
            (this._dash = ws(s[1] - s[0])),
            (this._offset = ws(-s[0])),
            ...
            ds &&
              (a = fs.getComputedStyle(t)).strokeLinecap !== a.strokeLinejoin &&
              ((o = Cs(a.strokeMiterlimit)),
              this.add(t.style, "strokeMiterlimit", o, o + 0.01)),
            (this._live = As(t) || ~(e + "").indexOf("live")),
    ...
    var Bs,
      ...
      zs = function (t) {
        (Bs = Is()),
          (Ns = Bs && Bs.parseEase("_CE"))
            ? ((Ls = 1),
              (Bs.parseEase("bounce").config = function (t) {
                return "object" == typeof t
                  ? js("", t)
                  : js("bounce(" + t + ")", { strength: +t });
              }))
            : t &&
              console.warn(
      ...
      js = function (t, e) {
        ...
        for (
          ...
          c &&
            ...
            m.push(_ - c, 1, _, 1, _, 1),
            (c *= l * l)),
          m.push(_, 1, r, s, i, s, n, s, a, 1, a, 1),
          (l *= 0.95),
          (f = g / (a - n)),
          (_ = a),
          !(s > 0.999));
        ...
        if (e.endAtStart && "false" !== e.endAtStart) {
          if (((i = -0.1), m.unshift(i, 1, i, 1, -0.07, 0), h))
            for (
              i -= c = 2.5 * h,
        ...
        return (
          c &&
            (Xs(D),
            (D[2] = "C" + D[2]),
            Ns(e.squashID || t + "-squash", "M" + D.join(","))),
          Xs(m),
          (m[2] = "C" + m[2]),
          Ns(t, "M" + m.join(","))
        );
    ...
    var qs,
      ...
      $s = function (t) {
        if (!Gs)
          if (((qs = Hs()), (Vs = qs && qs.parseEase("_CE")))) {
            for (var e in Us) Us[e] = Vs("", Us[e]);
            (Gs = 1),
              (Zs("wiggle").config = function (t) {
                return "object" == typeof t
                  ? Zs("", t)
                  : Zs("wiggle(" + t + ")", { wiggles: +t });
              });
          } else
            t &&
              console.warn(
      ...
      Qs = function (t, e) {
        return (
          "function" != typeof t && (t = qs.parseEase(t) || Vs("", t)),
          t.custom || !e
            ? t
            : function (e) {
                return 1 - t(e);
      ...
      Zs = function (t, e) {
        ...
        var r,
          ...
          f = h / 2,
          d = "anticipate" === e.type,
          g = Us[e.type] || Us.easeOut,
          _ = Ws;
        if (
          (d && ((_ = g), (g = Us.easeOut)),
          e.timingEase && (_ = Qs(e.timingEase)),
          e.amplitudeEase && (g = Qs(e.amplitudeEase, !0)),
          (l = [0, 0, (a = _(f)) / 4, 0, a / 2, (u = d ? -g(f) : g(f)), a, u]),
          "random" === e.type)
        ) {
          for (
            l.length = 4, r = _(h), n = 2 * Math.random() - 1, p = 2;
            p < c;
            p++
          )
            (f = r),
              ...
              (r = _(h * p)),
              (n = 2 * Math.random() - 1),
              (i = Math.atan2(n - l[l.length - 3], r - l[l.length - 4])),
              (s = Math.cos(i) * h),
              (o = Math.sin(i) * h),
              l.push(f - s, u - o, f, u, f + s, u + o);
          l.push(r, 0, 1, 0);
        } else {
          for (p = 1; p < c; p++)
            l.push(_(f + h / 2), u),
    ...
    var Ks,
      ...
      po = function (t) {
        ...
        !(uo in t.style) &&
          ...
          (lo = (uo = "msTransform") + "Origin");
        for (; e.parentNode && (e = e.parentNode); );
        if (((to = window), (so = new Do()), e)) {
          (Ks = e),
            (eo = e.documentElement),
            (ro = e.body),
            ((oo = Ks.createElementNS(
              "http://www.w3.org/2000/svg",
              "g"
      ...
      go = function t(e) {
        return (
          "fixed" === to.getComputedStyle(e).position ||
      ...
      _o = function t(e, r) {
        if (e.parentNode && (Ks || po(e))) {
          var n = fo(e),
            ...
            l = Ks.createElementNS
              ? Ks.createElementNS(i.replace(/^https/, "http"), s)
              : Ks.createElement(s);
          return (
            r &&
              (n
    ...
    function vo(t, e, r, n) {
      if (!t || !t.parentNode || (Ks || po(t)).documentElement === t)
        return new Do();
      var i = (function (t) {
          for (var e, r; t && t !== ro; )
        ...
        o = (function (t, e) {
          ...
          if (t === to) return t;
          if (
            (p.length || p.push(_o(t, 1), _o(t, 2), _o(t, 3)),
            (r = u ? io : no),
            u)
          )
            l
                    ...
                    r ||
                      ...
                      e
                        ...
                        : t.style.removeProperty(
                            uo.replace(/([A-Z])/g, "-$1").toLowerCase()
                          )),
                    r || so.clone()
                  );
                })(t)),
              ...
              ? ((i = t.getBBox()),
                (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems
                  ? n.numberOfItems > 1
                    ? (function (t) {
                        for (var e = new Do(), r = 0; r < t.numberOfItems; r++)
            ...
            if (((s = o = 0), ao))
              for (
                ...
                (to.getComputedStyle(i)[uo] + "").length > 4 &&
                  ((s = i.offsetLeft), (o = i.offsetTop), (i = 0));
            if (
              "absolute" !== (a = to.getComputedStyle(t)).position &&
              "fixed" !== a.position
            )
     ...
     */ var yo,
      ...
      Co,
      Fo,
      Eo = "x,translateX,left,marginLeft,xPercent".split(","),
      To = "y,translateY,top,marginTop,yPercent".split(","),
      So = Math.PI / 180,
      Mo = function (t, e, r, n) {
        for (var i = e.length, s = 2 === n ? 0 : n, o = 0; o < i; o++)
          (t[s] = parseFloat(e[o][r])), 2 === n && (t[s + 1] = 0), (s += 2);
        return t;
      },
      Ao = function (t, e, r) {
      ...
      Oo = function (t, e, r, n, i, s, o, a, u) {
        return (
          "cubic" === o.type
            ? (e = [e])
            : (!1 !== o.fromCurrent &&
                e.unshift(Ao(r, n, a), i ? Ao(r, i, u) : 0),
              o.relative && Ro(e),
              (e = [(i ? ts : Ki)(e, o.curviness)])),
          (e = s(No(e, r, o))),
          Io(t, r, n, e, "x", a),
          i && Io(t, r, i, e, "y", u),
          Hi(e, o.resolution || (0 === o.curviness ? 20 : 12))
        );
      },
      Po = function (t) {
        return t;
      ...
      Bo = function (t, e, r) {
        ...
        return (
          ...
          e &&
            "auto" !== e &&
            ((s = e.push ? e[0] * (n ? n.width : t.offsetWidth || 0) : e.x),
            (o = e.push ? e[1] * (n ? n.height : t.offsetHeight || 0) : e.y)),
          r.apply(s || o ? i.apply({ x: s, y: o }) : { x: i.e, y: i.f })
        );
      },
      Lo = function (t, e, r, n) {
        var i,
          s = vo(t.parentNode, !0, !0),
        ...
        return (
          ...
          "auto" === n &&
            ...
            ((i = e.getAttribute("d").match(ko) || []),
            (l += (i = o.apply({ x: +i[0], y: +i[1] })).x),
            (p += i.y)),
          i && ((l -= (i = o.apply(e.getBBox())).x), (p -= i.y)),
          (o.e = l - a.x),
          (o.f = p - a.y),
          o
        );
          ...
          ? (o &&
              ("self" === o || (n = wo(o)[0] || e) === e
                ...
                : (p && !1 !== p[2]
                  ...
                  (s = (i = Lo(e, n, p, "auto")).apply({ x: c, y: h })),
                  Qi(
                    t,
                    i.a,
                    i.b,
            ...
            a
              ? Qi(t, a.a, a.b, a.c, a.d, a.e, a.f)
              : (u || l) && Qi(t, 1, 0, 0, 1, u || 0, l || 0),
            t)
          : Xi("M0,0L0,0");
      },
      ...
      zo = {
        ...
        register: function (t, e, r) {
          (bo = (yo = t).utils.getUnit),
            (wo = yo.utils.toArray),
            (Co = yo.core.getStyleSaver),
            (Fo = yo.core.reverting || function () {}),
            (xo = r);
        },
        init: function (t, e, r) {
          if (!yo)
          ...
          if (
            ...
            (this.target = t),
            (this.tween = r),
            (this.styles = Co && Co(t, "transform")),
            (this.rotate = p || 0 === p) &&
              ((this.rOffset = parseFloat(p) || 0),
              (this.radians = !!e.useRadians),
              (this.rProp = e.rotation || "rotation"),
              (this.rSet = t._gsap.set(t, this.rProp, this)),
              (this.ru = bo(t._gsap.get(t, this.rProp)) || 0)),
            Array.isArray(l) && !("closed" in l) && "number" != typeof g)
          ) {
            for (i in g)
              !f && ~Eo.indexOf(i) ? (f = i) : !d && ~To.indexOf(i) && (d = i);
            for (i in (f && d
              ? a.push(
                  Oo(
                    this,
            ...
            g))
              i !== f &&
                i !== d &&
                a.push(Oo(this, Mo([], l, i, 2), t, i, 0, _, e, bo(l[0][i])));
          } else
            Hi((n = _(No(Xi(e.path), t, e))), e.resolution),
              a.push(n),
              Io(this, t, e.x || "x", n, "x", e.unitX || "px"),
              Io(this, t, e.y || "y", n, "y", e.unitY || "px");
        },
        render: function (t, e) {
          var r = e.rawPaths,
            n = r.length,
          ...
          if (e.tween._time || !Fo()) {
            ...
            e.rotate &&
              e.rSet(
                e.target,
                e.rProp,
                r[0].angle * (e.radians ? So : 1) + e.rOffset + e.ru,
                e,
                t
              );
          } else e.styles.revert();
                  ...
                  "rect" === C
                    ...
                    : ("polyline" !== C && "polygon" !== C) ||
                      ((r =
                        "M" +
                        (n = (p =
                          (t.getAttribute("points") + "").match(mi) ||
                          []).shift()) +
                        "," +
                        (i = p.shift()) +
                        " L" +
                        p.join(",")),
                      "polygon" === C && (r += "," + n + "," + i + "z")),
                  a.setAttribute("d", es((a._gsRawPath = Ji(r)))),
                  e &&
                    t.parentNode &&
        ...
        arrayToRawPath: function (t, e) {
          ...
          return (
            e.relative && Ro(r), ["cubic" === e.type ? r : ts(r, e.curviness)]
          );
        },
      };
    function Xo(t) {
    ...
    var jo,
      ...
      Ua = function (t, e) {
        ...
        return Math.max(
          0,
          Ha(t)
            ? Math.max(Go[n], Vo[n]) - (Yo["inner" + r] || Go[i] || Vo[i])
            : t[n] - t[i]
        );
      },
      Wa = function t(e, r) {
      ...
      Ja = function (t) {
        if (t === Yo)
          return (
            (Za.left = Za.top = 0),
            (Za.width = Za.right =
              Go.clientWidth || t.innerWidth || Vo.clientWidth || 0),
            (Za.height = Za.bottom =
              (t.innerHeight || 0) - 20 < Go.clientHeight
                ? Go.clientHeight
                : t.innerHeight || Vo.clientHeight || 0),
            Za
          );
        var e = t.ownerDocument || qo,
          r = da(t.pageX)
            ? t.nodeType || da(t.left) || da(t.top)
              ? Qo(t)[0].getBoundingClientRect()
              : t
            : {
                left: t.pageX - qa(e),
                top: t.pageY - Ya(e),
      ...
      ru = function (t, e) {
        ...
        if (t === Yo)
          (i = Ya(_)),
            ...
            (s =
              i +
              ((t.innerHeight || 0) - 20 < _.documentElement.clientHeight
                ? _.documentElement.clientHeight
                : t.innerHeight || _.body.clientHeight || 0));
        else {
          if (e === Yo || da(e)) return t.getBoundingClientRect();
          (r = i = 0),
            g
              ? ((h = (c = t.getBBox()).width), (f = c.height))
              : (t.viewBox &&
                  (c = t.viewBox.baseVal) &&
                  ((r = c.x || 0),
                  (i = c.y || 0),
        ...
        return t === e
          ? { left: r, top: i, width: n - r, height: s - i }
          : ((a = (o = vo(e, !0).multiply(vo(t))).apply({ x: r, y: i })),
            (u = o.apply({ x: n, y: i })),
            (l = o.apply({ x: n, y: s })),
            (p = o.apply({ x: r, y: s })),
            {
      ...
      su = function (t, e) {
        for (var r, n = t.length; n--; )
          ((r = t[n]).ondragstart = r.onselectstart = e ? null : ga),
            jo.set(r, { lazy: !0, userSelect: e ? "text" : "none" });
      },
      ou = function t(e) {
        return (
          "fixed" === Qa(e).position ||
        ...
        aa && !1 !== e.force3D
          ...
          (this.left = function (r, n) {
            ...
            if ((i > 2 || i < -2) && !n)
              return (
                (d = t.scrollLeft),
                jo.killTweensOf(this, { left: 1, scrollLeft: 1 }),
                this.left(-d),
            ...
            (r = -r) < 0
              ...
              : (h = 0),
              (h || s) &&
                (this._skip || (l[_a] = o + -h + "px," + -c + a),
                h + m >= 0 && (l.paddingRight = h + m + "px")),
              (t.scrollLeft = 0 | r),
              (d = t.scrollLeft);
          }),
          (this.top = function (r, n) {
            ...
            if ((i > 2 || i < -2) && !n)
              return (
                (f = t.scrollTop),
                jo.killTweensOf(this, { top: 1, scrollTop: 1 }),
                this.top(-f),
                void (e.onKill && e.onKill())
              );
            (r = -r) < 0
              ...
              ? ((c = (r - v) | 0), (r = v))
              : (c = 0),
              (c || s) && (this._skip || (l[_a] = o + -h + "px," + -c + a)),
              (t.scrollTop = 0 | r),
              (f = t.scrollTop);
          }),
          ...
          (this.disable = function () {
            for (p = u.firstChild; p; )
              (s = p.nextSibling), t.appendChild(p), (p = s);
          ...
          (this.calibrate = function (e) {
            ...
            (f = t.scrollTop),
              ...
              (p &&
                ...
                (p && !e) ||
                  ...
                  (m = Math.max(0, t.scrollWidth - t.clientWidth)) &&
                    (m +=
                      ...
                      (ua ? parseFloat(s.paddingRight) : 0))),
                ...
                (l.width = "100%"),
                (l.paddingRight = m + "px"),
                ua && (l.paddingBottom = s.paddingBottom),
                (r = t.clientWidth),
                (n = t.clientHeight),
                (g = t.scrollWidth),
                (_ = t.scrollHeight),
      ...
      uu = function (t) {
        if (pa() && document.body) {
          ...
          (Yo = window),
            (qo = document),
            (Go = qo.documentElement),
            (Vo = qo.body),
            (Ho = ya("div")),
            (ia = !!window.PointerEvent),
            ((Uo = ya("div")).style.cssText =
              "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab"),
            (na = "grab" === Uo.style.cursor ? "grab" : "move"),
            (ea = e && -1 !== e.userAgent.toLowerCase().indexOf("android")),
            (Jo =
              ("ontouchstart" in Go && "orientation" in Yo) ||
            ...
            Na(qo, "touchcancel", ga),
            Na(Yo, "touchmove", ga),
            Vo && Vo.addEventListener("touchstart", ga),
            Na(qo, "contextmenu", function () {
        ...
        var r, n, i, s, o;
        jo
          ? ((ra = jo.plugins.inertia),
            (sa = jo.core.context || function () {}),
            ($o = jo.utils.checkPrefix),
            (_a = $o(_a)),
            (ma = $o(ma)),
            (Qo = jo.utils.toArray),
            (oa = jo.core.getStyleSaver),
            (aa = !!$o("perspective")))
      ...
      lu = (function (t) {
        ...
        function n(e, r) {
          ...
          (i = t.call(this) || this),
            Wo || uu(1),
            (e = Qo(e)[0]),
            (i.styles = oa && oa(e, "transform,left,top")),
            ra || (ra = jo.plugins.inertia),
            (i.vars = r = Oa(r || {})),
            (i.target = e),
          ...
          var s,
                  ...
                  Q = !1,
                    ...
                    Ra.scrollLeft =
                      null != Yo.pageXOffset
                        ...
                        : ot.body.scrollLeft,
                    a = H.pointerX - Ra.scrollLeft,
                    u = H.pointerY - Ra.scrollTop;
                  f && !i;

                )
                  (n = (i = Ha(f.parentNode)) ? Ra : f.parentNode),
                    (s = i
                      ? {
                          bottom: Math.max(
                            Go.clientHeight,
                    ...
                    q &&
                      ((c = n._gsMaxScrollX - n.scrollLeft) < 0
                        ...
                        : a < s.left + tt &&
                          ...
                          (l = -Math.min(
                            n.scrollLeft,
                            (d * (1 - Math.max(0, a - s.left) / tt)) | 0
                          ))),
                      l && (n.scrollLeft += l)),
                    i &&
                      (l || p) &&
                      (Yo.scrollTo(n.scrollLeft, n.scrollTop),
                      xt(H.pointerX + l, H.pointerY + p)),
                    (f = n);
              }
              if (x) {
                var g = H.x,
                  _ = H.y;
                X
                  ? ((H.deltaX = g - parseFloat(nt.rotation)),
                    (H.rotation = g),
                    (nt.rotation = g + "deg"),
                    nt.renderTransform(1, nt))
                  : o
                  ? (G && ((H.deltaY = _ - o.top()), o.top(_)),
                    q && ((H.deltaX = g - o.left()), o.left(g)))
                  : z
                  ? (G &&
                      ((H.deltaY = _ - parseFloat(nt.y)), (nt.y = _ + "px")),
                    q && ((H.deltaX = g - parseFloat(nt.x)), (nt.x = g + "px")),
                    nt.renderTransform(1, nt))
                  : (G &&
                      ((H.deltaY = _ - parseFloat(e.style.top || 0)),
                      (e.style.top = _ + "px")),
                    q &&
                      ((H.deltaX = g - parseFloat(e.style.left || 0)),
                      (e.style.left = g + "px"))),
                  !h ||
                    r ||
                    O ||
                    ((O = !0),
                    !1 === Ka(H, "drag", "onDrag") &&
                      (q && (H.x -= H.deltaX), G && (H.y -= H.deltaY), t(!0)),
                    (O = !1));
              }
              x = !1;
            },
            lt = function (t, r) {
              var n,
                ...
                s = H.x,
                a = H.y;
              e._gsap || (nt = jo.core.getCache(e)),
                nt.uncache && jo.getProperty(e, "x"),
                z
                  ? ((H.x = parseFloat(nt.x)), (H.y = parseFloat(nt.y)))
                  : X
                  ? (H.x = H.rotation = parseFloat(nt.rotation))
                  : o
                  ? ((H.y = o.top()), (H.x = o.left()))
                  : ((H.y =
                      parseFloat(e.style.top || ((i = Qa(e)) && i.top)) || 0),
                    (H.x = parseFloat(e.style.left || (i || {}).left) || 0)),
                (w || C || F) &&
                  !r &&
                  (H.isDragging || H.isThrowing) &&
                  (F &&
                    ((Aa.x = H.x),
                    (Aa.y = H.y),
                    (n = F(Aa)).x !== H.x && ((H.x = n.x), (x = !0)),
                    n.y !== H.y && ((H.y = n.y), (x = !0))),
                  w &&
                    (n = w(H.x)) !== H.x &&
                    ((H.x = n), X && (H.rotation = n), (x = !0)),
                  C && ((n = C(H.y)) !== H.y && (H.y = n), (x = !0))),
                x && ut(!0),
                t ||
                  ((H.deltaX = H.x - s),
                  (H.deltaY = H.y - a),
                  Ka(H, "throwupdate", "onThrowUpdate"));
            },
            pt = function (t, e, r, n) {
              return (
                null == e && (e = -ba),
                ...
                ha(t)
                  ...
                  : va(t)
                  ? function (n) {
                      for (var i, s, o = t.length, a = 0, u = ba; --o > -1; )
                        (s = (i = t[o]) - n) < 0 && (s = -s),
                          s < u && i >= e && i <= r && ((a = o), (u = s));
                      return t[a];
                    }
            ...
            ct = function () {
              ...
              (c = !1),
                o
                  ? (o.calibrate(),
                    (H.minX = g = -o.maxScrollLeft()),
                    (H.minY = m = -o.maxScrollTop()),
                    (H.maxX = d = H.maxY = _ = 0),
                    (c = !0))
                  : r.bounds &&
                    ((t = tu(r.bounds, e.parentNode)),
                    X
                      ? ((H.minX = g = t.left),
                        (H.maxX = d = t.left + t.width),
                        (H.minY = m = H.maxY = _ = 0))
                      : da(r.bounds.maxX) && da(r.bounds.maxY)
                      ? ((n = tu(e, e.parentNode)),
                        (H.minX = g =
                          Math.round(st(j, "px") + t.left - n.left)),
                        (H.minY = m = Math.round(st(Y, "px") + t.top - n.top)),
                        (H.maxX = d = Math.round(g + (t.width - n.width))),
                        (H.maxY = _ = Math.round(m + (t.height - n.height))))
                      : ((t = r.bounds),
                        (H.minX = g = t.minX),
                        (H.minY = m = t.minY),
                        (H.maxX = d = t.maxX),
                        (H.maxY = _ = t.maxY)),
                    g > d && ((H.minX = d), (H.maxX = d = g), (g = H.minX)),
                    m > _ && ((H.minY = _), (H.maxY = _ = m), (m = H.minY)),
                    X && ((H.minRotation = g), (H.maxRotation = d)),
                    (c = !0)),
                r.liveSnap &&
                  ((i = !0 === r.liveSnap ? r.snap || {} : r.liveSnap),
                  (s = va(i) || ha(i)),
                  X
                    ? ((w = pt(s ? i : i.rotation, g, d, 1)), (C = null))
                    : i.points
                    ? (F = (function (t, e, r, n, i, s, o) {
                        return (
                          (s = s && s < ba ? s * s : ba),
                          ha(t)
                            ? function (a) {
                                var u,
                                  l,
                                  p,
                                  c = H.isPressed ? 1 - H.edgeResistance : 1,
                                  h = a.x,
                                  f = a.y;
                                return (
                                  (a.x = h =
                            ...
                            ? function (e) {
                                for (
                                  var r, n, i, o, a = t.length, u = 0, l = ba;
                                  --a > -1;
                      ...
                      })(s ? i : i.points, g, d, m, _, i.radius, o ? -1 : 1))
                    : (q &&
                        (w = pt(
            ...
            dt = function (t, n) {
              ...
              t && ra
                ? (!0 === t &&
                    ...
                    X
                      ? (t.rotation = nu(H, s ? i : i.rotation, d, g, 1, n))
                      : (q &&
                          (t[j] = nu(
                            H,
                        ...
                        (i.points || (va(i) && fa(i[0]))) &&
                          ((t.linkedProps = j + "," + Y),
                          (t.radius = i.radius)))),
                  (H.isThrowing = !0),
                  (u = isNaN(r.overshootTolerance)
                    ? 1 === r.edgeResistance
                      ? 0
                      : 1 - H.edgeResistance + 0.2
            ...
            _t = function () {
              ...
              z &&
                ...
                (a = eu.x),
                (u = eu.y),
                x && (xt(H.pointerX, H.pointerY), ut(!0)),
                (L = vo(e)),
                o
                  ? (ct(), (p = o.top()), (l = o.left()))
                  : (mt() ? (lt(!0, !0), ct()) : H.applyBounds(),
                    X
                      ? ((t = e.ownerSVGElement
                          ? [
                ...
                if (
                  ...
                  Ko[t.type]
                    ? ((T = ~t.type.indexOf("touch")
                      ...
                      Na(T, "touchcancel", bt),
                      Na(ot, "touchstart", ja))
                    : ((T = null), Na(ot, "mousemove", yt)),
                  (R = null),
                  (ia && T) ||
                    (Na(ot, "mouseup", bt),
                    t && t.target && Na(t.target, "mouseup", bt)),
                  (E = et.call(H, t.target) && !1 === r.dragClickables && !i))
                )
                  return (
                    Na(t.target, "change", bt),
                    Ka(H, "pressInit", "onPressInit"),
                    Ka(H, "press", "onPress"),
                    su(U, !0),
                    void (B = !1)
                  );
                ...
                if (
                  ((A =
                    !(
                      !T ||
                      q === G ||
                      !1 === H.vars.allowNativeTouchScrolling ||
                      (H.vars.allowContextMenu &&
                        t &&
                        (t.ctrlKey || t.which > 2))
                    ) && (q ? "y" : "x")),
                  (B = !A && !H.allowEventDefault) &&
                    (za(t), Na(Yo, "touchforcechange", za)),
                  t.changedTouches
                    ? ((t = D = t.changedTouches[0]), (v = t.identifier))
                    : t.pointerId
                    ? (v = t.pointerId)
                    : (D = v = null),
                  la++,
                  (p = ut),
                  Fa.push(p),
                  1 === Fa.length && jo.ticker.add(ka),
                  (u = H.pointerY = t.pageY),
                  (a = H.pointerX = t.pageX),
                  Ka(H, "pressInit", "onPressInit"),
                  (A || H.autoScroll) && Wa(e.parentNode),
                  !e.parentNode ||
                    !H.autoScroll ||
                    o ||
                    X ||
                    ...
                    Uo.parentNode ||
                    e.getBBox ||
                    ((Uo.style.width = e.parentNode.scrollWidth + "px"),
                    e.parentNode.appendChild(Uo)),
                  _t(),
                  H.tween && H.tween.kill(),
                  (H.isThrowing = !1),
                  jo.killTweensOf(o || e, W, !0),
                  o && jo.killTweensOf(e, { scrollTo: 1 }, !0),
                  (H.tween = H.lockedAxis = null),
                  (r.zIndexBoost || (!X && !o && !1 !== r.zIndexBoost)) &&
                    (e.style.zIndex = n.zIndex++),
                  (H.isPressed = !0),
                  (h = !(!r.onDrag && !H._listeners.drag)),
                  (f = !(!r.onMove && !H._listeners.move)),
              ...
              if (s && !ta && H.isPressed && t) {
                if (((H.pointerEvent = t), (r = t.changedTouches))) {
                  if ((t = r[0]) !== D && t.identifier !== v) {
                    for (
                      o = r.length;
                      --o > -1 && (t = r[o]).identifier !== v && t.target !== e;
                ...
                A &&
                !R &&
                ((eu.x = t.pageX - (it ? qa(ot) : 0)),
                (eu.y = t.pageY - (it ? Ya(ot) : 0)),
                S && S.apply(eu, eu),
                (n = eu.x),
                (i = eu.y),
                (((l = Math.abs(n - a)) !== (p = Math.abs(i - u)) &&
                  (l > V || p > V)) ||
                  (ea && A === R)) &&
                  ((R = l > p && q ? "x" : "y"),
                  A && R !== A && Na(Yo, "touchforcechange", za),
                  !1 !== H.vars.lockAxisOnTouchScroll &&
                    q &&
                    G &&
                    ((H.lockedAxis = "x" === R ? "y" : "x"),
                    ha(H.vars.onLockAxis) && H.vars.onLockAxis.call(H, c)),
                  ea && A === R))
                  ? bt(c)
                  : (H.allowEventDefault ||
                    (A && (!R || A === R)) ||
            ...
            xt = function (t, e, r) {
              ...
              (H.pointerX = t),
                ...
                it && ((t -= qa(ot)), (e -= Ya(ot))),
                X
                  ? ((o = Math.atan2(y.y - e, t - y.x) * xa),
                    (h = H.y - o) > 180
                      ? ((p -= 360), (H.y = o))
                      : h < -180 && ((p += 360), (H.y = o)),
                    H.x !== l || Math.abs(p - o) > V
                      ? ((H.y = o), (s = l + (p - o) * D))
                      : (s = l))
                  : (S &&
                      ((f = t * S.a + e * S.c + S.e),
                    ...
                    (i = e - u) < V && i > -V && (i = 0),
                    (n = t - a) < V && n > -V && (n = 0),
                    (H.lockAxis || H.lockedAxis) &&
                      (n || i) &&
                      ((f = H.lockedAxis) ||
                        ((H.lockedAxis = f =
                          q && Math.abs(n) > Math.abs(i)
                            ? "y"
                            : G
                            ? "x"
                            : null),
                        f &&
                          ha(H.vars.onLockAxis) &&
                          H.vars.onLockAxis.call(H, H.pointerEvent)),
                      "y" === f ? (i = 0) : "x" === f && (n = 0)),
                    (s = Da(l + n * D)),
                    (o = Da(p + i * D))),
                (w || C || F) &&
                ...
                c &&
                  (s > d
                    ...
                    : s < g && (s = g + Math.round((s - g) * v)),
                  X ||
                    (o > _
                      ? (o = Math.round(_ + (o - _) * v))
                      : o < m && (o = Math.round(m + (o - m) * v)))),
                (H.x !== s || (H.y !== o && !X)) &&
                  (X
                    ? ((H.endRotation = H.x = H.endX = s), (x = !0))
                    : (G && ((H.y = H.endY = o), (x = !0)),
                      q && ((H.x = H.endX = s), (x = !0))),
                  r && !1 === Ka(H, "move", "onMove")
                    ? ((H.pointerX = b),
                      (H.pointerY = E),
                      (p = T),
                      (H.x = M),
            ...
            bt = function t(n, i) {
              if (
                ...
                (!n ||
                  ...
                  i ||
                  !(
                    (n.pointerId && n.pointerId !== v && n.target !== e) ||
                    (n.changedTouches &&
                      !(function (t, e) {
                ...
                var o,
                  ...
                  h = H.isDragging,
                  f =
                    H.vars.allowContextMenu && n && (n.ctrlKey || n.which > 2),
                  d = jo.delayedCall(0.001, Dt);
                if (
                  (T
                    ? (Ia(T, "touchend", t),
                      Ia(T, "touchmove", yt),
                      ...
                      Ia(ot, "touchstart", ja))
                    : Ia(ot, "mousemove", yt),
                  Ia(Yo, "touchforcechange", za),
                  (ia && T) ||
                    (Ia(ot, "mouseup", t),
                    n && n.target && Ia(n.target, "mouseup", t)),
                  (x = !1),
                  h && (($ = Ma = Ca()), (H.isDragging = !1)),
                  La(ut),
                  E && !f)
                )
                  return (
                    n && (Ia(n.target, "change", t), (H.pointerEvent = c)),
                    su(U, !1),
                    Ka(H, "release", "onRelease"),
                    Ka(H, "click", "onClick"),
                    void (E = !1)
                  );
                for (a = U.length; --a > -1; )
                  $a(U[a], "cursor", r.cursor || (!1 !== r.cursor ? na : null));
                if ((la--, n)) {
                  if (
                    (o = n.changedTouches) &&
                    (n = o[0]) !== D &&
                    ...
                    for (
                      a = o.length;
                      --a > -1 && (n = o[a]).identifier !== v && n.target !== e;
                ...
                return (
                  f && c
                    ? (za(c), (B = !0), Ka(H, "release", "onRelease"))
                    : c && !h
                    ? ((B = !1),
                      M &&
                        (r.snap || r.bounds) &&
                      ...
                      (ea && "touchmove" === c.type) ||
                        ...
                        (Ka(H, "click", "onClick"),
                        Ca() - rt < 300 &&
                          Ka(H, "doubleclick", "onDoubleClick"),
                        (l = c.target || e),
                        (rt = Ca()),
                        (p = function () {
                          rt === P ||
                            ...
                            (l.click
                              ...
                              : ot.createEvent &&
                                ((u =
                                  ...
                                  Yo,
                                  1,
                                  H.pointerEvent.screenX,
                                  H.pointerEvent.screenY,
                                  H.pointerX,
                                  H.pointerY,
                                  !1,
                                  !1,
                        ...
                        ea || c.defaultPrevented || jo.delayedCall(0.05, p)))
                    : (dt(r.inertia || r.throwProps),
                      H.allowEventDefault ||
                      !c ||
                      (!1 === r.dragClickables && et.call(H, c.target)) ||
                      !h ||
                      (A && (!R || A !== R)) ||
                      !1 === c.cancelable
                        ? (B = !1)
                        : ((B = !0), za(c)),
                      Ka(H, "release", "onRelease")),
                  mt() && d.duration(H.tween.duration()),
                  h && Ka(H, "dragend", "onDragEnd"),
                  !0
                );
              }
              B && n && s && za(n);
            ...
            wt = function (t) {
              if (t && H.isDragging && !o) {
                ...
                (n || i) &&
                  (S
                    ? ((a -= n * S.a + i * S.c), (u -= i * S.d + n * S.b))
                    : ((a -= n), (u -= i)),
                  (r._gsScrollX += n),
                  (r._gsScrollY += i),
                  xt(H.pointerX, H.pointerY));
              }
            },
            Ct = function (t) {
              var e = Ca(),
              ...
              if (
                ((i || (n && !1 !== H.vars.suppressClickOnDrag)) &&
                  t.stopImmediatePropagation &&
                  t.stopImmediatePropagation(),
                r &&
                  (!H.pointerEvent || !H.pointerEvent.defaultPrevented) &&
                  (!i || (a && !o)))
              )
                return a && i && (k = rt), void (P = rt);
              (H.isPressed || n || r) && ((a && t.detail && r && !s) || za(t)),
                r ||
                  n ||
                  N ||
                  (t && t.target && (H.pointerEvent = t),
                  Ka(H, "click", "onClick"));
            },
            Ft = function (t) {
              return S
          ...
          return (
            ...
            (i.startDrag = function (t, r) {
              var n, i, s, o;
              vt(t || H.pointerEvent, !0),
                r &&
                  !H.hitTest(t || H.pointerEvent) &&
                  ((n = Ja(t || H.pointerEvent)),
                  (i = Ja(e)),
                  (s = Ft({
                    x: n.left + n.width / 2,
                    y: n.top + n.height / 2,
                  ...
                  (u -= s.y - o.y)),
                H.isDragging ||
                  ((H.isDragging = N = !0), Ka(H, "dragstart", "onDragStart"));
            }),
            (i.drag = yt),
              ...
              var n,
                ...
                c =
                  "velocity" === t && ra
                    ...
                    : "start";
              return (
                "element" === c && ((a = Ja(H.target)), (u = Ja(t))),
                (n =
                  "start" === c
                    ? H.x - l
                    : "velocity" === c
              ...
              if ((lt(!0), ct(), c && !mt())) {
                if (
                  ...
                  (H.x !== i || H.y !== s) &&
                    ((o = !0),
                    (H.x = H.endX = i),
                    X ? (H.endRotation = i) : (H.y = H.endY = s),
                    (x = !0),
                    ut(!0),
                  ...
                  for (
                    ...
                    (u = (l = Ha(a.parentNode)) ? Ra : a.parentNode),
                      G &&
                      ...
                      (a = u);
                H.isThrowing &&
                  (o || H.endX > d || H.endX < g || H.endY > _ || H.endY < m) &&
                  dt(r.inertia || r.throwProps, o);
              }
              return H;
            }),
            (i.update = function (t, r, n) {
              ...
              return (
                gt(!r),
                t ? H.applyBounds() : (x && n && ut(!0), lt(!0)),
                r && (xt(H.pointerX, H.pointerY), x && ut(!0)),
                H.isPressed &&
                  !r &&
                  ((q && Math.abs(a - H.x) > 0.01) ||
                    (G && Math.abs(u - H.y) > 0.01 && !X)) &&
                  _t(),
                H.autoScroll &&
                  (Wa(e.parentNode, H.isDragging),
                  (Q = H.isDragging),
                  ut(!0),
                  Va(e, wt),
                  Ga(e, wt)),
            ...
            (i.enable = function (t) {
              var n,
                ...
                u = { lazy: !0 };
              if (
                (!1 !== r.cursor && (u.cursor = r.cursor || na),
                jo.utils.checkPrefix("touchCallout") &&
                  (u.touchCallout = "none"),
                "soft" !== t)
              ) {
                for (
              ...
              return (
                ...
                ra &&
                  "soft" !== t &&
                  ra.track(o || e, z ? "x,y" : X ? "rotation" : "top,left"),
                (e._gsDragID = n = "d" + Ta++),
                (Ea[n] = H),
            ...
            (i.disable = function (t) {
              for (var r, n = H.isDragging, i = U.length; --i > -1; )
                $a(U[i], "cursor", null);
              if ("soft" !== t) {
                for (Pa(U, null), i = U.length; --i > -1; )
                  (r = U[i]),
                    $a(r, "touchCallout", null),
                    Ia(r, "mousedown", vt),
                    Ia(r, "touchstart", vt),
                    Ia(r, "click", Ct, !0),
                    Ia(r, "contextmenu", at);
              ...
              return (
                ...
                ra &&
                  "soft" !== t &&
                  (ra.untrack(o || e, z ? "x,y" : X ? "rotation" : "top,left"),
                  H.tween && H.tween.kill()),
                o && o.disable(),
                La(ut),
                (H.isDragging = H.isPressed = E = !1),
                n && Ka(H, "dragend", "onDragEnd"),
                H
              );
            }),
            ...
            (i.kill = function () {
              return (
                ...
                H.tween && H.tween.kill(),
                H.disable(),
                jo.set(U, { clearProps: "userSelect" }),
                delete Ea[e._gsDragID],
                H
              );
            }),
            (i.revert = function () {
            ...
            ~I.indexOf("scroll") &&
              ...
              (e.style.overflowY = G && !Jo ? "auto" : "hidden"),
              (e.style.overflowX = q && !Jo ? "auto" : "hidden"),
              (e = o.content)),
            X ? (W.rotation = 1) : (q && (W[j] = 1), G && (W[Y] = 1)),
          ...
          (n.hitTest = function (t, e, r) {
            ...
            return d || !r
              ...
              : ((s = -1 !== (r + "").indexOf("%")),
                ...
                }).width = Math.min(p, a.right) - n.left),
                (n.height = Math.min(c, a.bottom) - n.top),
                !(n.width < 0 || n.height < 0) &&
                  (s
                    ? ((r *= 0.01),
                      (i = n.width * n.height) >= h * f * r ||
    ...
    var pu,
      ...
      Fu = function (t, e, r, n) {
        (this.t = t),
          (this.p = e),
          (this.g = t._gsap.get),
          (this.rCap = wu[r || fu(this.g(t, e))]),
          (this.v1 = this.v2 = 0),
          (this.t1 = this.t2 = gu.time),
      ...
      Eu = (function () {
        ...
        return (
          (e.get = function (t, e) {
            ...
            return (
              (r = parseFloat(e ? s.v1 : s.g(s.t, s.p)) - parseFloat(s.v2)),
              (n = s.rCap) &&
                (r %= n) != r % (n / 2) &&
                (r = r < 0 ? r + n : r - n),
              (i = r / ((e ? s.t1 : gu.time) - s.t2)),
          ...
          (e.add = function (t, e) {
            t in this._props ||
              (du || (gu.add(bu), (_u = gu.time)),
              (du = this._props[t] = new Fu(this.target, t, e, du)));
          }),
          (e.remove = function (t) {
            var e,
              r,
            ...
            n &&
              ...
              (r = n._next),
              e && (e._next = r),
              r ? (r._prev = e) : du === n && (gu.remove(bu), (du = 0)),
          ...
          (t.track = function (e, r, n) {
            ...
            for (
              ...
              for (i = xu(a[p]) || new t(a[p]), s = u.length; s--; )
                i.add(u[s], l[s] || l[0]);
              o.push(i);
            }
            return o;
    ...
    var Tu,
      ...
      Zu = function t(e) {
        var r,
          n,
          i = {};
        for (r in e) i[r] = Vu((n = e[r])) && !Uu(n) ? t(n) : n;
        return i;
      },
      ...
      Ku = function (t, e, r, n, i, s, o) {
        ...
        if (((r = isNaN(r) ? $u : r), (n = isNaN(n) ? -1e10 : n), Vu(e))) {
          ...
          a = a[i];
        } else a = Hu(l) ? l(e, o) : Uu(l) ? Ju(e, l, r, n, s) : parseFloat(l);
        return (
          a > r ? (a = r) : a < n && (a = n),
      ...
      il = function (t, e, r, n) {
        if (e.linkedProps) {
          var i,
            ...
            u,
            l,
            p = e.linkedProps.split(","),
            c = {};
          for (i = 0; i < p.length; i++)
            (o = e[(s = p[i])]) &&
              ((a = Gu(o.velocity)
                ? o.velocity
                : (u = u || Yu(t)) && u.isTracking(s)
                ? u.get(s)
                : 0),
              (l = Math.abs(a / tl(o, "resistance", n))),
              (c[s] = parseFloat(r(t, s)) + el(a, l)));
          return c;
        }
      },
      sl = function () {
        (Tu = qu()) &&
          ...
          (Bu = Tu.core.getCache),
          (Nu = Tu.utils.clamp),
          (zu = Tu.core.getStyleSaver),
          (Xu = Tu.core.reverting || function () {}),
          (Ru = Mu("power3")),
          (Lu = Ru(0.05)),
          (ku = Tu.core.PropTween),
          Tu.config({
            resistance: 100,
            unitFactors: {
              time: 1e3,
      ...
      ol = {
        ...
        init: function (t, e, r, n, i) {
          ...
          (this.styles = zu && "object" == typeof t.style && zu(t)),
            (this.target = t),
            (this.tween = r),
            (Iu = e);
          var o,
            ...
            y = tl(e, "resistance", Ou.resistance),
            x = Gu(m)
              ? m
              : (function (t, e, r, n, i, s) {
                  ...
                  var o,
                    ...
                    D = e.inertia || e,
                    v = Bu(t).get,
                    y = tl(D, "resistance", Ou.resistance);
                  for (o in ((g = il(t, D, v, y)), D))
                    nl[o] ||
                      ((a = D[o]),
                      Vu(a) ||
                        ((f = f || Yu(t)) && f.isTracking(o)
                          ? (a = Gu(a)
                              ? { velocity: a }
                              : { velocity: f.get(o) })
                      ...
                      Vu(a) &&
                        ((l = Gu(a.velocity)
                          ...
                          ? f.get(o)
                          : 0),
                        (u = Nu(n, r, Math.abs(l / tl(a, "resistance", y)))),
                        (c = (p = parseFloat(v(t, o)) || 0) + el(l, u)),
                        "end" in a &&
                          ((a = Ku(
                            a,
                            g && o in g ? g : c,
                        ...
                        "max" in a && c > +a.max + 1e-10
                          ? ((d = a.unitFactor || Ou.unitFactors[o] || 1),
                            (h =
                              (p > a.max && a.min !== a.max) ||
                              (l * d > -15 && l * d < 45)
                                ? n + 0.1 * (r - n)
                  ...
                  (D && m.max) || 10,
                  (D && m.min) || 0.2,
                  D && "overshoot" in m ? +m.overshoot : v ? 0 : 1,
                  !0
                );
          for (o in ((e = Iu), (Iu = 0), (d = il(t, e, _, y)), e))
            nl[o] ||
              ((a = e[o]),
              Hu(a) && (a = a(n, t, i)),
              Gu(a)
                ? (p = a)
                : Vu(a) && !isNaN(a.velocity)
                ? (p = +a.velocity)
                : s && s.isTracking(o)
                ? (p = s.get(o))
                : console.warn(
        ...
        render: function (t, e) {
          var r,
            n = e._pt;
          if ((t = Ru(e.tween._time / e.tween._dur)) || !Xu())
            for (; n; )
              n.set(
                n.t,
                n.p,
                ((r = n.s + n.c1 * t + n.c2 * t * t),
                Math.round(1e4 * r) / 1e4 + n.u),
                n.d,
                t
              ),
                (n = n._next);
    ...
    "track,untrack,isTracking,getVelocity,getByTarget"
      ...
      qu() && Tu.registerPlugin(ol),
      qn.registerPlugin(We, Gn, Ne, Ne, Yn, gi, ks, ps, Ys, Js, zo, lu, ol),
      (window._tpt ??= {});
    var al = (ju = window.punchgs = window.tpGS = _tpt);
    for (var ul in ((_tpt.gsap = qn),
    (_tpt.TweenLite = We),
    (_tpt.TweenMax = Gn),
    (_tpt.TimelineLite = Ne),
    (_tpt.TimelineMax = Ne),
    (_tpt.CSSPlugin = Yn),
    (_tpt.SplitText = gi),
    (_tpt.motionPath = zo),
    (_tpt.CustomEase = ps),
    (_tpt.CustomBounce = Ys),
    (_tpt.CustomWiggle = Js),
    (_tpt.DrawSVGPlugin = ks),
    (_tpt.draggable = lu),
    (_tpt.Inertia = ol),
    (_tpt.RAD2DEG = 180 / Math.PI),
    (_tpt.DEG2RAD = Math.PI / 180),
    _tpt.gsap.config({ nullTargetWarn: !1 }),
    /*!FallBack for old and new Eases*/
    (_tpt.eases = _tpt.gsap.parseEase()),
    _tpt.eases))
      _tpt.eases.hasOwnProperty(ul) &&
        void 0 === al[ul] &&
        (al[ul] = _tpt.eases[ul]);
    /*! FallBack for Essential Grid */
    void 0 !== ju &&
      void 0 !== ju.TweenLite &&
      void 0 === ju.TweenLite.lagSmoothing &&
      (ju.TweenLite.lagSmoothing = function () {}),
      _tpt.CustomEase.create(
        "late",
      ...
      (_tpt.SFXBounceLite = _tpt.CustomBounce.create("SFXBounceLite", {
        strength: 0.3,
        squash: 1,
      ...
      (_tpt.R = _tpt.R || {}),
      (_tpt.R.tpgsap = _tpt.extend
        ? _tpt.extend(_tpt.R.tpgsap, { status: 2, version: "1.0" })
